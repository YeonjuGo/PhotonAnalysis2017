...
do
    ...
    root -l -b -q 'performance/toyStudy_responseMatrix.C++("pp","'${verName_un[$i]}'")' >& log/correlation_toyStudy_responseMatrix_pp_${verName_un[$i]}.log
    root -l -b -q 'performance/toyStudy_responseMatrix.C++("pbpb","'${verName_un[$i]}'")' >& log/correlation_toyStudy_responseMatrix_pbpb_${verName_un[$i]}.log
    ...
    source /home/goyeonju/root/builddir/bin/thisroot.sh
    root -l -b -q 'results/drawUnfoldingFigures_v3.C++("'${verName_un[$i]}'")' >& log/drawUnfoldingFigures_${verName_un[$i]}.log
