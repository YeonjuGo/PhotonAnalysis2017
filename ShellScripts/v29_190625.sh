...
#    root -l -b -q 'results/getRawDist_v7.C++("'${verName_f[$i]}'",1,1)' >& log/getRawDist_v7_${verName_f[$i]}.log & sleep 20
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding.C++("'${verName_f[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_${verName_f[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
#    root -l -b -q 'results/getRawDist_v7.C++("'${verName_fa[$i]}'",1,1)' >& log/getRawDist_v7_${verName_fa[$i]}.log & sleep 20
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding.C++("'${verName_fa[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_${verName_fa[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
