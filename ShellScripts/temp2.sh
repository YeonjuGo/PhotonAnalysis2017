#!/bin/bash
#yj_quickPhotonPurity(const TString coll="pbpb", const TString ver="170523_temp_v1_NewPurityMethod", bool useSBcorr=1, bool noCentDepCorr=1, bool useMCSB=0)
...
verFileCopy_b=('180427_temp_v11')
verName_b=('180427_temp_v11')

for ((i=0; i< ${#verName_b[@]};i++))
do
    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_b[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile.C++("pbpb","'${verName_b[$i]}'")' >& log/iso_efficiency_withSkimFile_pbpb_${verName_b[$i]}.log
#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile.C++("pp","'${verName_b[$i]}'")' >& log/iso_efficiency_withSkimFile_pp_${verName_b[$i]}.log
#    root -l -b -q 'efficiency/reco_efficiency_withForest.C++("pp","'${verName_b[$i]}'")' >& log/iso_efficiency_withSkimFile_pp_${verName_b[$i]}.log
...
verFileCopy_c=('180427_temp_v12')
verName_c=('180427_temp_v12')
for ((i=0; i< ${#verName_c[@]};i++))
do
    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_c[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile.C++("pbpb","'${verName_c[$i]}'")' >& log/iso_efficiency_withSkimFile_pbpb_${verName_c[$i]}.log
#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile.C++("pp","'${verName_c[$i]}'")' >& log/iso_efficiency_withSkimFile_pp_${verName_c[$i]}.log
...
verFileCopy_d=('180501_temp_v13')
verName_d=('180501_temp_v13')
for ((i=0; i< ${#verName_d[@]};i++))
do
    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_d[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile.C++("pbpb","'${verName_d[$i]}'")' >& log/iso_efficiency_withSkimFile_pbpb_${verName_d[$i]}.log
#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile.C++("pp","'${verName_d[$i]}'")' >& log/iso_efficiency_withSkimFile_pp_${verName_d[$i]}.log
    ...
    root -l -b -q 'results/getRawDist.C++("'${verName_d[$i]}'")' >& log/getRawDist_${verName_d[$i]}.log
