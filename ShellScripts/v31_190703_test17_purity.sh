...
##    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v8_beforeUnfolding_withTnP.C++("'${verName_a[$i]}'",1)' >& log/drawRaaXsec_v8_beforeUnfolding_withTnP_${verName_a[$i]}.log
...
###    wait $(jobs -p)
###    root -l -b -q 'results/drawRaaXsec_v8_beforeUnfolding_withTnP.C++("'${verName_c[$i]}'",1)' >& log/drawRaaXsec_v8_beforeUnfolding_withTnP_${verName_c[$i]}.log
###    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
#done
#
verFileCopy_dmore4=('190703_temp_v31_sys_purDown_more4_no2012SigmaVar')
verName_dmore4=('190703_temp_v31_sys_purDown_more4_no2012SigmaVar')
preverName_dmore4=('180822_temp_v24_sys_purDown_more4_no2012SigmaVar')
...
do
    ...
    root -l -b -q 'purity/yj_quickPhotonPurity_v3.C++("pbpb","'${verName_dmore4[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_pbpb_${verName_dmore4[$i]}.log & sleep 20
    root -l -b -q 'purity/yj_quickPhotonPurity_v3.C++("pp","'${verName_dmore4[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_pp_${verName_dmore4[$i]}.log
    wait $(jobs -p)
    ...
    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_dmore4[$i]}'",0,1)' >& log/fitPurity_pbpb_${verName_dmore4[$i]}.log & sleep 20
    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_dmore4[$i]}'",0,1)' >& log/fitPurity_pp_${verName_dmore4[$i]}.log & sleep 20
    wait $(jobs -p)
...
###    root -l -b -q 'purity/yj_quickPhotonPurity_v3.C++("pbpb","'${verName_dmore3[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_pbpb_${verName_dmore3[$i]}.log & sleep 20
###    root -l -b -q 'purity/yj_quickPhotonPurity_v3.C++("pp","'${verName_dmore3[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_pp_${verName_dmore3[$i]}.log
###    wait $(jobs -p)
...
###    root -l -b -q 'purity/yj_quickPhotonPurity_v3.C++("pbpb","'${verName_dmore2[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_pbpb_${verName_dmore2[$i]}.log & sleep 20
###    root -l -b -q 'purity/yj_quickPhotonPurity_v3.C++("pp","'${verName_dmore2[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_pp_${verName_dmore2[$i]}.log
###    wait $(jobs -p)
...
###    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_dmore2[$i]}'",1,1)' >& log/fitPurity_pbpb_${verName_dmore2[$i]}.log & sleep 20
###    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_dmore2[$i]}'",1,1)' >& log/fitPurity_pp_${verName_dmore2[$i]}.log & sleep 20
###    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v8_beforeUnfolding_withTnP.C++("'${verName_dmore2[$i]}'",1)' >& log/drawRaaXsec_v8_beforeUnfolding_withTnP_${verName_dmore2[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
###    root -l -b -q 'purity/yj_quickPhotonPurity_v3.C++("pbpb","'${verName_dmore[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_pbpb_${verName_dmore[$i]}.log & sleep 20
###    root -l -b -q 'purity/yj_quickPhotonPurity_v3.C++("pp","'${verName_dmore[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_pp_${verName_dmore[$i]}.log
###    wait $(jobs -p)
...
###    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_dmore[$i]}'",1,1)' >& log/fitPurity_pbpb_${verName_dmore[$i]}.log & sleep 20
###    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_dmore[$i]}'",1,1)' >& log/fitPurity_pp_${verName_dmore[$i]}.log & sleep 20
###    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v8_beforeUnfolding_withTnP.C++("'${verName_dmore[$i]}'",1)' >& log/drawRaaXsec_v8_beforeUnfolding_withTnP_${verName_dmore[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
###        wait $(jobs -p)
####        root -l -b -q 'results/drawRaaXsec_v8_beforeUnfolding_withTnP_withTnP.C++("'${verName_tnp[$i]}'",1)' >& log/drawRaaXsec_v8_beforeUnfolding_withTnP_withTnP_${verName_tnp[$i]}.log
###        source /data/ROOT-v5.34.21/bin/thisroot.sh
...
#####    wait $(jobs -p)
#####    root -l -b -q 'results/drawRaaXsec_v8_beforeUnfolding_withTnP.C++("'${verName_f[$i]}'",1)' >& log/drawRaaXsec_v8_beforeUnfolding_withTnP_${verName_f[$i]}.log
#####    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
#####    wait $(jobs -p)
#####    root -l -b -q 'results/drawRaaXsec_v8_beforeUnfolding_withTnP.C++("'${verName_fa[$i]}'",1)' >& log/drawRaaXsec_v8_beforeUnfolding_withTnP_${verName_fa[$i]}.log
#####    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
####    wait $(jobs -p)
####    root -l -b -q 'results/drawRaaXsec_v8_beforeUnfolding_withTnP.C++("'${verName_b[$i]}'",1)' >& log/drawRaaXsec_v8_beforeUnfolding_withTnP_${verName_b[$i]}.log
###    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
####    wait $(jobs -p)
####    root -l -b -q 'results/drawRaaXsec_v8_beforeUnfolding_withTnP.C++("'${verName_j[$i]}'")' >& log/drawRaaXsec_v8_beforeUnfolding_withTnP_${verName_j[$i]}.log
###    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
####    wait $(jobs -p)
####    root -l -b -q 'results/drawRaaXsec_v8_beforeUnfolding_withTnP.C++("'${verName_e[$i]}'",1)' >& log/drawRaaXsec_v8_beforeUnfolding_withTnP_${verName_e[$i]}.log
