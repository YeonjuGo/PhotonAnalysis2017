...
verName=('170824_temp_v7_OldPurityMethod')
...
do
    ...
    root -l -b -q 'purity/yj_quickPhotonPurity.C++("pbpb","'${verName[$i]}'",0,0,0)' >& log/yj_quickPhotonPurity_pbpb_${verName[$i]}.log
    root -l -b -q 'purity/yj_quickPhotonPurity.C++("pp","'${verName[$i]}'",0,0,0)' >& log/yj_quickPhotonPurity_pp_${verName[$i]}.log
