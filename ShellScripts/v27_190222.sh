...
verFileCopy_a=('190222_temp_v27')
verName_a=('190222_temp_v27_nominal')
...
#    root -l -b -q 'performance/divideTree.C++' >& log/divideTree_pbpb_20180815skim.log
    root -l -b -q 'performance/correlation_genPt_recoPt.C++("pbpb","'${verName_a[$i]}'",1)' >& log/correlation_pbpb_${verName_a[$i]}_splitMC.log
    root -l -b -q 'performance/correlation_genPt_recoPt.C++("pp","'${verName_a[$i]}'",1)' >& log/correlation_pp_${verName_a[$i]}_splitMC.log
    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
#
verFileCopy_l=('190222_temp_v27')
verName_l=('190222_temp_v27_sys_unfolding_svd')
...
do
    ...
    source /data/ROOT-v5.34.21/bin/thisroot.sh
    python results/RooUnfold_photonRaa_v4.py ${verName_a[$i]} svd splitMC >& log/RooUnfold_photonRaa_v4_${verName_a[$i]}_splitMC.log
    source /home/goyeonju/root/builddir/bin/thisroot.sh
    root -l -b -q 'results/drawUnfoldingFigures.C++("'${verName_a[$i]}'",1)' >& log/drawUnfoldingFigures_${verName_a[$i]}_splitMC.log
...
do
    verFileCopy_m=('190222_temp_v27')
    verName_m=('190222_temp_v27_sys_unfolding_iterative'$j)
    ...
    do
        ...
        source /data/ROOT-v5.34.21/bin/thisroot.sh
        python results/RooUnfold_photonRaa_v4.py ${verName_m[$i]} $j splitMC >& log/RooUnfold_photonRaa_v4_${verName_m[$i]}.log
        source /home/goyeonju/root/builddir/bin/thisroot.sh
...
#verFileCopy_p=('190222_temp_v27')
#verName_p=('190222_temp_v27_sys_unfolding_iterative4')
...
#    cp ./results/output/phoRaa_${verName_a[$i]}_beforeUnfolding.root ./results/output/phoRaa_${verName_p[$i]}_beforeUnfolding.root
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
#done
#
#verFileCopy_n=('190222_temp_v27')
#verName_n=('190222_temp_v27_sys_unfolding_iterative3')
...
#    cp ./results/output/phoRaa_${verName_a[$i]}_beforeUnfolding.root ./results/output/phoRaa_${verName_n[$i]}_beforeUnfolding.root
...
#done
#
#verFileCopy_o=('190222_temp_v27')
#verName_o=('190222_temp_v27_sys_unfolding_iterative2')
...
#    cp ./results/output/phoRaa_${verName_a[$i]}_beforeUnfolding.root ./results/output/phoRaa_${verName_o[$i]}_beforeUnfolding.root
...
#done
#
#verFileCopy_q=('190222_temp_v27')
#verName_q=('190222_temp_v27_sys_unfolding_iterative1')
...
#    cp ./results/output/phoRaa_${verName_a[$i]}_beforeUnfolding.root ./results/output/phoRaa_${verName_q[$i]}_beforeUnfolding.root
...
#done
#
#verFileCopy_r=('190222_temp_v27')
#verName_r=('190222_temp_v27_sys_unfolding_iterative6')
...
#    cp ./results/output/phoRaa_${verName_a[$i]}_beforeUnfolding.root ./results/output/phoRaa_${verName_r[$i]}_beforeUnfolding.root
...
#verFileCopy_c=('190222_temp_v27_sys_purUp')
#verName_c=('190222_temp_v27_sys_purUp')
...
#done
#
#verFileCopy_d=('190222_temp_v27_sys_purDown')
#verName_d=('190222_temp_v27_sys_purDown')
...
#done
#
#verFileCopy_f=('190222_temp_v27_sys_IDup')
#verName_f=('190222_temp_v27_sys_IDup')
...
#done
#
#verFileCopy_fa=('190222_temp_v27_sys_IDdown')
#verName_fa=('190222_temp_v27_sys_IDdown')
...
#done
#
#verFileCopy_b=('190222_temp_v27_sys_phoEscale')
#verName_b=('190222_temp_v27_sys_phoEscale')
...
#done
#
#verFileCopy_j=('190222_temp_v27_sys_phoEresol')
#verName_j=('190222_temp_v27_sys_phoEresol')
...
#done
#
#verFileCopy_e=('190222_temp_v27_sys_eleCont')
#verName_e=('190222_temp_v27_sys_eleCont')
...
#done
#
#verFileCopy_h=('190222_temp_v27_sys_TAAup')
#verName_h=('190222_temp_v27_sys_TAAup')
...
#done
#
#verFileCopy_ha=('190222_temp_v27_sys_TAAdown')
#verName_ha=('190222_temp_v27_sys_TAAdown')
...
#done
#
#verFileCopy_t=('190222_temp_v27_sys_TAA')
#verName_t=('190222_temp_v27_sys_TAA')
...
#done
##
##verFileCopy_k=('190222_temp_v27_sys_phoEresol_sigDown')
##verName_k=('190222_temp_v27_sys_phoEresol_sigDown')
