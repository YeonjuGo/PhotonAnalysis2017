...
##
verFileCopy_tnp=('190625_temp_v29_TnP')
verName_tnp=('190625_temp_v29_TnP')
for ((i=0; i< ${#verName_tnp[@]};i++))
    do
        ...
        wait $(jobs -p)
        root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP.C++("'${verName_tnp[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_${verName_tnp[$i]}.log
        source /data/ROOT-v5.34.21/bin/thisroot.sh
...
#python results/RooUnfold_photonRaa_v6.py ${verName_tnp[$i]} svd 5 noSplitMC  >& log/RooUnfold_photonRaa_v6_${verName_tnp[$i]}.log
        source /home/goyeonju/root/builddir/bin/thisroot.sh
        root -l -b -q 'results/drawUnfoldingFigures_v3.C++("'${verName_tnp[$i]}'")' >& log/drawUnfoldingFigures_${verName_tnp[$i]}.log
        cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pbpb_splitMC.root ./performance/output/correlation_genPt_recoPt_${verName_tnp[$i]}_pbpb_splitMC.root 
        cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pp_splitMC.root ./performance/output/correlation_genPt_recoPt_${verName_tnp[$i]}_pp_splitMC.root 
        source /data/ROOT-v5.34.21/bin/thisroot.sh
        python results/RooUnfold_photonRaa_v6.py ${verName_tnp[$i]} 30 0 splitMC >& log/RooUnfold_photonRaa_v6_${verName_tnp[$i]}_splitMC.log
#python results/RooUnfold_photonRaa_v6.py ${verName_tnp[$i]} svd $j splitMC >& log/RooUnfold_photonRaa_v6_${verName_tnp[$i]}_splitMC.log
        source /home/goyeonju/root/builddir/bin/thisroot.sh
        root -l -b -q 'results/drawUnfoldingFigures_v3.C++("'${verName_tnp[$i]}'",1)' >& log/drawUnfoldingFigures_${verName_tnp[$i]}_splitMC.log
...
###    source /data/ROOT-v5.34.21/bin/thisroot.sh
###    python results/RooUnfold_photonRaa_v6.py ${verName_hhh[$i]} 30 0 noSplitMC  >& log/RooUnfold_photonRaa_v6_${verName_hhh[$i]}.log
###    source /home/goyeonju/root/builddir/bin/thisroot.sh
...
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP.C++("'${verName_f[$i]}'",0)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_${verName_f[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP.C++("'${verName_fa[$i]}'",0)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_${verName_fa[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
