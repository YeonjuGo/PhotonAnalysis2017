...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3.C++("pbpb","'${verName_a[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_pbpb_${verName_a[$i]}.log & sleep 20
    ...
    wait $(jobs -p)
    root -l -b -q 'performance/calculate_matrix_condition.C++("pbpb","'${verName_a[$i]}'")' >& log/calculate_matrix_condition_pbpb_${verName_a[$i]}.log & sleep 20
    root -l -b -q 'performance/calculate_matrix_condition.C++("pbpb","'${verName_a[$i]}'",1)' >& log/calculate_matrix_condition_pbpb_${verName_a[$i]}_splitMC.log & sleep 20 
    root -l -b -q 'performance/calculate_matrix_condition.C++("pp","'${verName_a[$i]}'")' >& log/calculate_matrix_condition_pp_${verName_a[$i]}.log & sleep 20 
    root -l -b -q 'performance/calculate_matrix_condition.C++("pp","'${verName_a[$i]}'",1)' >& log/calculate_matrix_condition_pp_${verName_a[$i]}_splitMC.log & sleep 20
...
#    python results/RooUnfold_photonRaa_v7.py ${verName_a[$i]} inv 0 noSplitMC >& log/RooUnfold_photonRaa_v7_${verName_a[$i]}.log
