...
verFileCopy_a=('180817_temp_v23')
verName_a=('180817_temp_v23_nominal')
...
##
#verFileCopy_c=('180817_temp_v23_sys_purUp')
#verName_c=('180817_temp_v23_sys_purUp')
...
#done
#
#verFileCopy_d=('180817_temp_v23_sys_purDown')
#verName_d=('180817_temp_v23_sys_purDown')
...
#done
#
##verFileCopy_f=('180817_temp_v23_sys_IDup')
##verName_f=('180817_temp_v23_sys_IDup')
...
##done
###
##verFileCopy_fa=('180817_temp_v23_sys_IDdown')
##verName_fa=('180817_temp_v23_sys_IDdown')
...
###
##
#verFileCopy_b=('180817_temp_v23_sys_phoEscale')
#verName_b=('180817_temp_v23_sys_phoEscale')
...
#done
###
#verFileCopy_e=('180817_temp_v23_sys_eleCont')
#verName_e=('180817_temp_v23_sys_eleCont')
...
#done
###
#verFileCopy_h=('180817_temp_v23_sys_eff')
#verName_h=('180817_temp_v23_sys_eff')
...
##    root -l -b -q 'efficiency/apply_TnP_SF.C++("pbpb","'${verFileCopy_a[$i]}'")' >& log/efficiency_apply_TnP_SF_pbpb_${verName_h[$i]}.log
##    root -l -b -q 'efficiency/apply_TnP_SF.C++("pp","'${verFileCopy_a[$i]}'")' >& log/efficiency_apply_TnP_SF_pp_${verName_h[$i]}.log
...
#verFileCopy_h=('180817_temp_v23_sys_TAAup')
#verName_h=('180817_temp_v23_sys_TAAup')
#for ((i=0; i< ${#verName_h[@]};i++))
#do
#    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_h[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#    cp ./efficiency/output/pbpb_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pbpb_iso_efficiency_${verName_h[$i]}.root
...
#done
#
#verFileCopy_ha=('180817_temp_v23_sys_TAAdown')
#verName_ha=('180817_temp_v23_sys_TAAdown')
...
#done
##
#verFileCopy_t=('180817_temp_v23_sys_TAA')
#verName_t=('180817_temp_v23_sys_TAA')
...
#
#
#verFileCopy_j=('180817_temp_v23_sys_phoEresol')
#verName_j=('180817_temp_v23_sys_phoEresol')
...
#done
###
##verFileCopy_k=('180817_temp_v23_sys_phoEresol_sigDown')
##verName_k=('180817_temp_v23_sys_phoEresol_sigDown')
...
verFileCopy_z=('180817_temp_v23_trigEffTest')
verName_z=('180817_temp_v23_trigEffTest')
for ((i=0; i< ${#verName_z[@]};i++))
do
    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_a[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
    cp ./efficiency/output/pbpb_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pbpb_iso_efficiency_${verName_z[$i]}.root
    cp ./efficiency/output/pp_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pp_iso_efficiency_${verName_z[$i]}.root
    cp ./purity/output/purity_pbpb_${verName_a[$i]}_splitPD.root ./purity/output/purity_pbpb_${verName_z[$i]}_splitPD.root
    cp ./purity/output/purity_pp_${verName_a[$i]}_splitPD.root ./purity/output/purity_pp_${verName_z[$i]}_splitPD.root
    cp ./results/output/rawDist_${verName_a[$i]}_splitPD.root ./results/output/rawDist_${verName_z[$i]}_splitPD.root
    root -l -b -q 'results/temp_drawRaaXsec_v3.C++("'${verName_z[$i]}'",0)' >& log/drawRaaXsec_v3_${verName_z[$i]}.log
done
