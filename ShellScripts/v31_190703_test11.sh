...
####    root -l -b -q 'performance/divideTree.C++' >& log/divideTree_pbpb_20180815skim.log
    ...
    root -l -b -q 'results/drawRaaXsec_v7_afterUnfolding.C++("'${verName_a[$i]}'",1,1,1)' >& log/drawRaaXsec_v7_afterUnfolding_splitMC_${verName_a[$i]}.log
#    
...
#    root -l -b -q 'results/drawRaaXsec_eleCont_subtraced_v2.C++("'${verName_e[$i]}'")' >& log/drawRaaXsec_eleCont_subtraced_v2_${verName_e[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
