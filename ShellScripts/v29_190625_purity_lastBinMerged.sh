#!/bin/bash
#int yj_quickPhotonPurity_v3_lastBinMerged(const TString coll="pbpb", const TString ver="phoRaaCuts_purity_forPaper", bool doSplitPD=true, bool doPreScale=0, bool useSBcorr=0, bool noCentDepCorr=0, bool useMCSB=0){
#verFileCopy_a=('1800802_temp_v20')

verFileCopy_a=('190625_temp_v29')
verName_a=('190625_temp_v29_nominal')
...
#     root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pbpb","'${verName_a[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pbpb_${verName_a[$i]}.log & sleep 20
...
#     root -l -b -q 'efficiency/iso_efficiency_withSkimFile_v3.C++("pp","'${verName_a[$i]}'")' >& log/iso_efficiency_withSkimFile_v3_pp_${verName_a[$i]}.log & sleep 20
     root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pp","'${verName_a[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pp_${verName_a[$i]}.log & sleep 20
...
#     root -l -b -q 'results/getRawDist_v7.C++("'${verName_a[$i]}'",1,1)' >& log/getRawDist_v7_${verName_a[$i]}.log & sleep 20 
     wait $(jobs -p)
#     root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding.C++("'${verName_a[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_${verName_a[$i]}.log
...
#
#verFileCopy_an=('190625_temp_v29')
#verName_an=('190625_temp_v29_noUnfolding')
...
#for j in {1..10} 
#do
#    verFileCopy_l=('190625_temp_v29')
#    verName_l=('190625_temp_v29_sys_unfolding_svd'$j)
...
#for j in {1..30}
#do
#    verFileCopy_m=('190625_temp_v29')
#    verName_m=('190625_temp_v29_sys_unfolding_iterative'$j)
...
#
#
verFileCopy_c=('190625_temp_v29_sys_purUp')
verName_c=('190625_temp_v29_sys_purUp')
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pbpb","'${verName_c[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pbpb_${verName_c[$i]}.log & sleep 20
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pp","'${verName_c[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pp_${verName_c[$i]}.log
...
#    cp ./results/output/rawDist_${verName_a[$i]}_splitPD.root ./results/output/rawDist_${verName_c[$i]}_splitPD.root
    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding.C++("'${verName_c[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_${verName_c[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
verFileCopy_d=('190625_temp_v29_sys_purDown')
verName_d=('190625_temp_v29_sys_purDown')
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pbpb","'${verName_d[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pbpb_${verName_d[$i]}.log & sleep 20
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pp","'${verName_d[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pp_${verName_d[$i]}.log
    wait $(jobs -p)
...
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding.C++("'${verName_d[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_${verName_d[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
#
#verFileCopy_hhh=('190625_temp_v29')
#verName_hhh=('190625_temp_v29_sys_eff')
...
#    source /home/goyeonju/root/builddir/bin/thisroot.sh
#    root -l -b -q 'results/drawUnfoldingFigures_v3.C++("'${verName_hhh[$i]}'")' >& log/drawUnfoldingFigures_${verName_hhh[$i]}.log
#    root -l -b -q 'results/drawRaaXsec_v7_afterUnfolding.C++("'${verName_hhh[$i]}'",1)' >& log/drawRaaXsec_v7_afterUnfolding_${verName_hhh[$i]}.log
#done
#
verFileCopy_f=('190625_temp_v29_sys_IDup')
verName_f=('190625_temp_v29_sys_IDup')
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pbpb","'${verName_f[$i]}'",1,0,0)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pbpb_${verName_f[$i]}.log & sleep 20
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pp","'${verName_f[$i]}'",1,0,0)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pp_${verName_f[$i]}.log & sleep 20
...
##    root -l -b -q 'results/getRawDist_v7.C++("'${verName_f[$i]}'",1,0)' >& log/getRawDist_v7_${verName_f[$i]}.log & sleep 20
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding.C++("'${verName_f[$i]}'",0)' >& log/drawRaaXsec_v7_beforeUnfolding_${verName_f[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
#
verFileCopy_fa=('190625_temp_v29_sys_IDdown')
verName_fa=('190625_temp_v29_sys_IDdown')
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pbpb","'${verName_fa[$i]}'",1,0,0)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pbpb_${verName_fa[$i]}.log & sleep 20
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pp","'${verName_fa[$i]}'",1,0,0)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pp_${verName_fa[$i]}.log & sleep 20
...
#    root -l -b -q 'results/getRawDist_v7.C++("'${verName_fa[$i]}'",1,0)' >& log/getRawDist_v7_${verName_fa[$i]}.log & sleep 20
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding.C++("'${verName_fa[$i]}'",0)' >& log/drawRaaXsec_v7_beforeUnfolding_${verName_fa[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
#
verFileCopy_b=('190625_temp_v29_sys_phoEscale')
verName_b=('190625_temp_v29_sys_phoEscale')
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pbpb","'${verName_b[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pbpb_${verName_b[$i]}.log & sleep 20
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pp","'${verName_b[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pp_${verName_b[$i]}.log & sleep 20
...
#    root -l -b -q 'results/getRawDist_v7.C++("'${verName_b[$i]}'",1,1)' >& log/getRawDist_v7_${verName_b[$i]}.log & sleep 20
    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding.C++("'${verName_b[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_${verName_b[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
#
verFileCopy_j=('190625_temp_v29_sys_phoEresol')
verName_j=('190625_temp_v29_sys_phoEresol')
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pbpb","'${verName_j[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pbpb_${verName_j[$i]}.log & sleep 20
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pp","'${verName_j[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pp_${verName_j[$i]}.log & sleep 20
...
#    root -l -b -q 'results/getRawDist_v7.C++("'${verName_j[$i]}'")' >& log/getRawDist_v7_${verName_j[$i]}.log & sleep 20
    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding.C++("'${verName_j[$i]}'")' >& log/drawRaaXsec_v7_beforeUnfolding_${verName_j[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
#
verFileCopy_e=('190625_temp_v29_sys_eleCont')
verName_e=('190625_temp_v29_sys_eleCont')
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pbpb","'${verName_e[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pbpb_${verName_e[$i]}.log & sleep 20
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3_lastBinMerged.C++("pp","'${verName_e[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_lastBinMerged_pp_${verName_e[$i]}.log & sleep 20
...
#    root -l -b -q 'results/getRawDist_v7.C++("'${verName_e[$i]}'",1,1)' >& log/getRawDist_v7_${verName_e[$i]}.log & sleep 20
    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding.C++("'${verName_e[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_${verName_e[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
#
#verFileCopy_h=('190625_temp_v29_sys_TAAup')
#verName_h=('190625_temp_v29_sys_TAAup')
...
#done
#
#verFileCopy_ha=('190625_temp_v29_sys_TAAdown')
#verName_ha=('190625_temp_v29_sys_TAAdown')
