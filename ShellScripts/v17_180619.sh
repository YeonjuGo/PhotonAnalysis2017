...
verFileCopy_a=('180619_temp_v17')
verName_a=('180619_temp_v17_nominal')
...
#done
#
#verFileCopy_f=('180619_temp_v17_sys_effUp')
#verName_f=('180619_temp_v17_sys_effUp')
...
#done
#
#verFileCopy_fa=('180619_temp_v17_sys_effDown')
#verName_fa=('180619_temp_v17_sys_effDown')
...
#done
#
#verFileCopy_c=('180619_temp_v17_sys_purUp')
#verName_c=('180619_temp_v17_sys_purUp')
...
#done
#
#verFileCopy_d=('180619_temp_v17_sys_purDown')
#verName_d=('180619_temp_v17_sys_purDown')
...
#done
#
verFileCopy_b=('180619_temp_v17_sys_phoEscale')
verName_b=('180619_temp_v17_sys_phoEscale')
...
##
#verFileCopy_e=('180619_temp_v17_sys_eleCont')
#verName_e=('180619_temp_v17_sys_eleCont')
...
#done
##
#verFileCopy_h=('180619_temp_v17_sys_TAA')
#verName_h=('180619_temp_v17_sys_TAA')
...
#done
#
#jverFileCopy_j=('180619_temp_v17_sys_phoEresol_sigUp')
#jverName_j=('180619_temp_v17_sys_phoEresol_sigUp')
#jfor ((i=0; i< ${#verName_j[@]};i++))
#jdo
#j    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_j[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#j#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile.C++("pbpb","'${verName_j[$i]}'")' >& log/efficiency_withSkimFile_pbpb_${verName_j[$i]}.log
#j    root -l -b -q 'efficiency/iso_efficiency_withSkimFile.C++("pp","'${verName_j[$i]}'")' >& log/efficiency_withSkimFile_pp_${verName_j[$i]}.log
#j#    root -l -b -q 'purity/yj_quickPhotonPurity.C++("pbpb","'${verName_j[$i]}'",0,0,0)' >& log/yj_quickPhotonPurity_pbpb_${verName_j[$i]}.log
#j    root -l -b -q 'purity/yj_quickPhotonPurity.C++("pp","'${verName_j[$i]}'",0,0,0)' >& log/yj_quickPhotonPurity_pp_${verName_j[$i]}.log
#j    root -l -b -q 'results/getRawDist.C++("'${verName_j[$i]}'")' >& log/getRawDist_${verName_j[$i]}.log
#j    root -l -b -q 'results/drawRaaXsec_v2.C++("'${verName_j[$i]}'")' >& log/drawRaaXsec_v2_${verName_j[$i]}.log
#jdone
#j
#jverFileCopy_k=('180619_temp_v17_sys_phoEresol_sigDown')
#jverName_k=('180619_temp_v17_sys_phoEresol_sigDown')
#jfor ((i=0; i< ${#verName_k[@]};i++))
#jdo
#j    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_k[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#j#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile.C++("pbpb","'${verName_k[$i]}'")' >& log/efficiency_withSkimFile_pbpb_${verName_k[$i]}.log
#j    root -l -b -q 'efficiency/iso_efficiency_withSkimFile.C++("pp","'${verName_k[$i]}'")' >& log/efficiency_withSkimFile_pp_${verName_k[$i]}.log
#j#    root -l -b -q 'purity/yj_quickPhotonPurity.C++("pbpb","'${verName_k[$i]}'",0,0,0)' >& log/yj_quickPhotonPurity_pbpb_${verName_k[$i]}.log
#j    root -l -b -q 'purity/yj_quickPhotonPurity.C++("pp","'${verName_k[$i]}'",0,0,0)' >& log/yj_quickPhotonPurity_pp_${verName_k[$i]}.log
#j    root -l -b -q 'results/getRawDist.C++("'${verName_k[$i]}'")' >& log/getRawDist_${verName_k[$i]}.log
#j    root -l -b -q 'results/drawRaaXsec_v2.C++("'${verName_k[$i]}'")' >& log/drawRaaXsec_v2_${verName_k[$i]}.log
#jdone
