...
do
    ...
    cp ./purity/output/purity_pbpb_${preverName_a[$i]}_splitPD.root ./purity/output/purity_pbpb_${verName_a[$i]}.root
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v2.C++("pp","'${verName_a[$i]}'",1,0)' >& log/yj_quickPhotonPurity_v2_pp_doPreScale_${verName_a[$i]}.log
    root -l -b -q 'results/getRawDist_v3.C++("'${verName_a[$i]}'",1,0)' >& log/getRawDist_v3_${verName_a[$i]}.log
    root -l -b -q 'results/drawRaaXsec_v3.C++("'${verName_a[$i]}'",0)' >& log/drawRaaXsec_v3_${verName_a[$i]}.log
done
...
do
    ...
    cp ./purity/output/purity_pbpb_${preverName_c[$i]}_splitPD.root ./purity/output/purity_pbpb_${verName_c[$i]}.root
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v2.C++("pp","'${verName_c[$i]}'",1,0,0)' >& log/yj_quickPhotonPurity_v2_pp_${verName_c[$i]}.log
    ...
    root -l -b -q 'results/drawRaaXsec_v3.C++("'${verName_c[$i]}'",0)' >& log/drawRaaXsec_v3_${verName_c[$i]}.log
done
...
do
    ...
    cp ./purity/output/purity_pbpb_${preverName_d[$i]}_splitPD.root ./purity/output/purity_pbpb_${verName_d[$i]}.root
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v2.C++("pp","'${verName_d[$i]}'",1,0,0)' >& log/yj_quickPhotonPurity_v2_pp_${verName_d[$i]}.log
    ...
    root -l -b -q 'results/drawRaaXsec_v3.C++("'${verName_d[$i]}'",0)' >& log/drawRaaXsec_v3_${verName_d[$i]}.log
done
...
verFileCopy_ha=('180731_temp_v19_sys_TAAdown')
verName_ha=('180731_temp_v19_sys_TAAdown')
...
verFileCopy_t=('180731_temp_v19_sys_TAA')
verName_t=('180731_temp_v19_sys_TAA')
