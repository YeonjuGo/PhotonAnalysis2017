...
verFileCopy_a=('180807_temp_v22')
verName_a=('180807_temp_v22_nominal')
...
#    cp ./purity/output/purity_pp_${preverName_a[$i]}_splitPD.root ./purity/output/purity_pp_${verName_a[$i]}.root
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v2.C++("pp","'${verName_a[$i]}'",1,0)' >& log/yj_quickPhotonPurity_v2_pp_${verName_a[$i]}.log
...
#
verFileCopy_c=('180807_temp_v22_sys_purUp')
verName_c=('180807_temp_v22_sys_purUp')
...
verFileCopy_d=('180807_temp_v22_sys_purDown')
verName_d=('180807_temp_v22_sys_purDown')
...
#verFileCopy_f=('180807_temp_v22_sys_IDup')
#verName_f=('180807_temp_v22_sys_IDup')
...
#done
##
#verFileCopy_fa=('180807_temp_v22_sys_IDdown')
#verName_fa=('180807_temp_v22_sys_IDdown')
...
##
#
#verFileCopy_b=('180807_temp_v22_sys_phoEscale')
#verName_b=('180807_temp_v22_sys_phoEscale')
...
#   root -l -b -q 'results/getRawDist_v3.C++("'${verName_b[$i]}'",1,0)' >& log/getRawDist_v3_${verName_b[$i]}.log
#    root -l -b -q 'results/drawRaaXsec_v3.C++("'${verName_b[$i]}'",0)' >& log/drawRaaXsec_v3_${verName_b[$i]}.log
#done
##
#verFileCopy_e=('180807_temp_v22_sys_eleCont')
#verName_e=('180807_temp_v22_sys_eleCont')
...
#   root -l -b -q 'results/getRawDist_v3.C++("'${verName_e[$i]}'",1,0)' >& log/getRawDist_v3_${verName_e[$i]}.log
#    root -l -b -q 'results/drawRaaXsec_v3.C++("'${verName_e[$i]}'",0)' >& log/drawRaaXsec_v3_${verName_e[$i]}.log
#done
##
#verFileCopy_h=('180807_temp_v22_sys_TAAup')
#verName_h=('180807_temp_v22_sys_TAAup')
...
#    root -l -b -q 'results/drawRaaXsec_v3.C++("'${verName_h[$i]}'",0)' >& log/drawRaaXsec_v3_${verName_h[$i]}.log
#done
#
#verFileCopy_ha=('180807_temp_v22_sys_TAAdown')
#verName_ha=('180807_temp_v22_sys_TAAdown')
...
#    cp ./purity/output/purity_pbpb_${verName_a[$i]}.root ./purity/output/purity_pbpb_${verName_ha[$i]}.root
#    cp ./purity/output/purity_pp_${verName_a[$i]}.root ./purity/output/purity_pp_${verName_ha[$i]}.root
#    cp ./results/output/rawDist_${verName_a[$i]}.root ./results/output/rawDist_${verName_ha[$i]}.root
#    root -l -b -q 'results/drawRaaXsec_v3.C++("'${verName_ha[$i]}'",0)' >& log/drawRaaXsec_v3_${verName_ha[$i]}.log
#done
#
#verFileCopy_t=('180807_temp_v22_sys_TAA')
#verName_t=('180807_temp_v22_sys_TAA')
...
#    cp ./purity/output/purity_pbpb_${verName_h[$i]}.root ./purity/output/purity_pbpb_${verName_t[$i]}.root
#    cp ./purity/output/purity_pp_${verName_h[$i]}.root ./purity/output/purity_pp_${verName_t[$i]}.root
#    cp ./results/output/rawDist_${verName_h[$i]}.root ./results/output/rawDist_${verName_t[$i]}.root
#    cp ./results/output/phoRaa_${verName_h[$i]}.root ./results/output/phoRaa_${verName_t[$i]}.root
#done
#
#
##verFileCopy_j=('180807_temp_v22_sys_phoEresol_sigUp')
##verName_j=('180807_temp_v22_sys_phoEresol_sigUp')
...
##done
##
##verFileCopy_k=('180807_temp_v22_sys_phoEresol_sigDown')
##verName_k=('180807_temp_v22_sys_phoEresol_sigDown')
