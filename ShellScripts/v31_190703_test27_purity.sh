...
#verFileCopy_side23=('190703_temp_v31_sidebandSigEffat85_v2')
#verName_side23=('190703_temp_v31_pur_sumIsoFit')
#preverName_side23=('190220_temp_v26_nominal')
#for ((i=0; i< ${#verName_side23[@]};i++))
#do
#    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_side23[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#    cp ./efficiency/output/pbpb_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pbpb_iso_efficiency_${verName_side23[$i]}.root
#    cp ./efficiency/output/pp_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pp_iso_efficiency_${verName_side23[$i]}.root
##    cp ./purity/output/purity_pbpb_190703_temp_v31_pur_sidebandSigEffat85_SBcorr_centDep_noPtDep_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pbpb_${verName_side23[$i]}_splitPD_noPreScale.root
#    root -l -b -q 'purity/yj_quickPhotonPurity_v5.C++("pbpb","'${verName_side23[$i]}'",1,0,0,0,0,0)' >& log/yj_quickPhotonPurity_v5_noPreScale_pbpb_${verName_side23[$i]}.log & sleep 20
##    cp ./purity/output/purity_pp_190703_temp_v31_pur_sidebandSigEffat85_SBcorr_centDep_noPtDep_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pp_${verName_side23[$i]}_splitPD_noPreScale.root
#    root -l -b -q 'purity/yj_quickPhotonPurity_v5.C++("pp","'${verName_side23[$i]}'",1,0,0,0,0,0)' >& log/yj_quickPhotonPurity_v5_noPreScale_pp_${verName_side23[$i]}.log
#    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pbpb.root ./performance/output/correlation_genPt_recoPt_${verName_side23[$i]}_pbpb.root 
#    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pp.root ./performance/output/correlation_genPt_recoPt_${verName_side23[$i]}_pp.root 
#    cp ./results/output/rawDist_${verName_a[$i]}_splitPD.root ./results/output/rawDist_${verName_side23[$i]}_splitPD.root
#    wait $(jobs -p)
#    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_side23[$i]}'",2,1)' >& log/fitPurity_pbpb_${verName_side23[$i]}.log & sleep 20
#    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_side23[$i]}'",2,1)' >& log/fitPurity_pp_${verName_side23[$i]}.log & sleep 20
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP_temp.C++("'${verName_side23[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_temp_${verName_side23[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
#    python results/RooUnfold_photonRaa_v6.py ${verName_side23[$i]} inv 0 noSplitMC  >& log/RooUnfold_photonRaa_v6_${verName_side23[$i]}.log
#    source /home/goyeonju/root/builddir/bin/thisroot.sh
##    root -l -b -q 'results/drawUnfoldingFigures_v3.C++("'${verName_side23[$i]}'")' >& log/drawUnfoldingFigures_${verName_side23[$i]}.log
#    root -l -b -q 'results/drawRaaXsec_v7_afterUnfolding.C++("'${verName_side23[$i]}'",1)' >& log/drawRaaXsec_v7_afterUnfolding_${verName_side23[$i]}.log
#done
#cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_a}.h ./phoRaaCuts/phoRaaCuts_temp.h
#root -l -b -q 'plotting/photonRaaPlot_withJetphox_v4_temp.C++("'${verName_side23}'")' >& log/plotting_v4_${verName_side23}.log

verFileCopy_side28=('190703_temp_v31_sidebandSigEffat85_v2')
verName_side28=('190703_temp_v31_pur_SBptDep10GeVinterval_ppPtDepCorr_pbpbCentDepPtDepCorr_Nfunc0')
preverName_side28=('190220_temp_v26_nominal')
for ((i=0; i< ${#verName_side28[@]};i++))
do
    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_side28[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
    cp ./efficiency/output/pbpb_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pbpb_iso_efficiency_${verName_side28[$i]}.root
    cp ./efficiency/output/pp_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pp_iso_efficiency_${verName_side28[$i]}.root
#   cp ./purity/output/purity_pbpb_190703_temp_v31_pur_sidebandSigEffat85_SBcorr_centDep_noPtDep_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pbpb_${verName_side28[$i]}_splitPD_noPreScale.root
#    root -l -b -q 'purity/yj_quickPhotonPurity_v4.C++("pbpb","'${verName_side28[$i]}'",1,0,1,0,50,0)' >& log/yj_quickPhotonPurity_v4_noPreScale_pbpb_${verName_side28[$i]}.log & sleep 20
    cp ./purity/output/purity_pp_190703_temp_v31_pur_SBptDep10GeVinterval_ppPtDepCorr_pbpbPtDepCorr_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pp_${verName_side28[$i]}_splitPD_noPreScale.root
#    root -l -b -q 'purity/yj_quickPhotonPurity_v4.C++("pp","'${verName_side28[$i]}'",1,0,1,0,50,0)' >& log/yj_quickPhotonPurity_v4_noPreScale_pp_${verName_side28[$i]}.log
    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pbpb.root ./performance/output/correlation_genPt_recoPt_${verName_side28[$i]}_pbpb.root 
    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pp.root ./performance/output/correlation_genPt_recoPt_${verName_side28[$i]}_pp.root 
    cp ./results/output/rawDist_${verName_a[$i]}_splitPD.root ./results/output/rawDist_${verName_side28[$i]}_splitPD.root
    wait $(jobs -p)
    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_side28[$i]}'",2,1)' >& log/fitPurity_pbpb_${verName_side28[$i]}.log & sleep 20
    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_side28[$i]}'",2,1)' >& log/fitPurity_pp_${verName_side28[$i]}.log & sleep 20
    wait $(jobs -p)
    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP_temp.C++("'${verName_side28[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_temp_${verName_side28[$i]}.log
    source /data/ROOT-v5.34.21/bin/thisroot.sh
    python results/RooUnfold_photonRaa_v6.py ${verName_side28[$i]} inv 0 noSplitMC  >& log/RooUnfold_photonRaa_v6_${verName_side28[$i]}.log
    source /home/goyeonju/root/builddir/bin/thisroot.sh
#    root -l -b -q 'results/drawUnfoldingFigures_v3.C++("'${verName_side28[$i]}'")' >& log/drawUnfoldingFigures_${verName_side28[$i]}.log
    root -l -b -q 'results/drawRaaXsec_v7_afterUnfolding.C++("'${verName_side28[$i]}'",1)' >& log/drawRaaXsec_v7_afterUnfolding_${verName_side28[$i]}.log
done
cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_a}.h ./phoRaaCuts/phoRaaCuts_temp.h
root -l -b -q 'plotting/photonRaaPlot_withJetphox_v4_temp.C++("'${verName_side28}'")' >& log/plotting_v4_${verName_side28}.log

verFileCopy_side29=('190703_temp_v31_sidebandSigEffat85')
verName_side29=('190703_temp_v31_pur_SBptDep5GeVinterval_ppPtDepCorr_pbpbCentDepPtDepCorr_Nfunc0')
preverName_side29=('190220_temp_v26_nominal')
for ((i=0; i< ${#verName_side29[@]};i++))
do
    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_side29[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
    cp ./efficiency/output/pbpb_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pbpb_iso_efficiency_${verName_side29[$i]}.root
    cp ./efficiency/output/pp_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pp_iso_efficiency_${verName_side29[$i]}.root
#   cp ./purity/output/purity_pbpb_190703_temp_v31_pur_sidebandSigEffat85_SBcorr_centDep_noPtDep_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pbpb_${verName_side29[$i]}_splitPD_noPreScale.root
#    root -l -b -q 'purity/yj_quickPhotonPurity_v4.C++("pbpb","'${verName_side29[$i]}'",1,0,1,0,50,0)' >& log/yj_quickPhotonPurity_v4_noPreScale_pbpb_${verName_side29[$i]}.log & sleep 20
    cp ./purity/output/purity_pp_190703_temp_v31_pur_SBptDep5GeVinterval_ppPtDepCorr_pbpbPtDepCorr_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pp_${verName_side29[$i]}_splitPD_noPreScale.root
#    root -l -b -q 'purity/yj_quickPhotonPurity_v4.C++("pp","'${verName_side29[$i]}'",1,0,1,0,50,0)' >& log/yj_quickPhotonPurity_v4_noPreScale_pp_${verName_side29[$i]}.log
    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pbpb.root ./performance/output/correlation_genPt_recoPt_${verName_side29[$i]}_pbpb.root 
    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pp.root ./performance/output/correlation_genPt_recoPt_${verName_side29[$i]}_pp.root 
    cp ./results/output/rawDist_${verName_a[$i]}_splitPD.root ./results/output/rawDist_${verName_side29[$i]}_splitPD.root
    wait $(jobs -p)
    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_side29[$i]}'",2,1)' >& log/fitPurity_pbpb_${verName_side29[$i]}.log & sleep 20
    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_side29[$i]}'",2,1)' >& log/fitPurity_pp_${verName_side29[$i]}.log & sleep 20
    wait $(jobs -p)
    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP_temp.C++("'${verName_side29[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_temp_${verName_side29[$i]}.log
    source /data/ROOT-v5.34.21/bin/thisroot.sh
    python results/RooUnfold_photonRaa_v6.py ${verName_side29[$i]} inv 0 noSplitMC  >& log/RooUnfold_photonRaa_v6_${verName_side29[$i]}.log
    source /home/goyeonju/root/builddir/bin/thisroot.sh
#    root -l -b -q 'results/drawUnfoldingFigures_v3.C++("'${verName_side29[$i]}'")' >& log/drawUnfoldingFigures_${verName_side29[$i]}.log
    root -l -b -q 'results/drawRaaXsec_v7_afterUnfolding.C++("'${verName_side29[$i]}'",1)' >& log/drawRaaXsec_v7_afterUnfolding_${verName_side29[$i]}.log
done
cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_a}.h ./phoRaaCuts/phoRaaCuts_temp.h
root -l -b -q 'plotting/photonRaaPlot_withJetphox_v4_temp.C++("'${verName_side29}'")' >& log/plotting_v4_${verName_side29}.log



#verFileCopy_side25=('190703_temp_v31_sidebandSigEffat85_v2')
#verName_side25=('190703_temp_v31_pur_SBptDep10GeVinterval_v2_ppPtDepCorr_pbpbPtDepCorr_Nfunc0')
#preverName_side25=('190220_temp_v26_nominal')
#for ((i=0; i< ${#verName_side25[@]};i++))
#do
#    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_side25[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#    cp ./efficiency/output/pbpb_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pbpb_iso_efficiency_${verName_side25[$i]}.root
#    cp ./efficiency/output/pp_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pp_iso_efficiency_${verName_side25[$i]}.root
##   cp ./purity/output/purity_pbpb_190703_temp_v31_pur_sidebandSigEffat85_SBcorr_centDep_noPtDep_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pbpb_${verName_side25[$i]}_splitPD_noPreScale.root
#    root -l -b -q 'purity/yj_quickPhotonPurity_v4.C++("pbpb","'${verName_side25[$i]}'",1,0,1,0,50,0)' >& log/yj_quickPhotonPurity_v4_noPreScale_pbpb_${verName_side25[$i]}.log & sleep 20
##    cp ./purity/output/purity_pp_190703_temp_v31_pur_sidebandSigEffat85_SBcorr_centDep_noPtDep_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pp_${verName_side25[$i]}_splitPD_noPreScale.root
#    root -l -b -q 'purity/yj_quickPhotonPurity_v4.C++("pp","'${verName_side25[$i]}'",1,0,1,0,50,0)' >& log/yj_quickPhotonPurity_v4_noPreScale_pp_${verName_side25[$i]}.log
#    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pbpb.root ./performance/output/correlation_genPt_recoPt_${verName_side25[$i]}_pbpb.root 
#    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pp.root ./performance/output/correlation_genPt_recoPt_${verName_side25[$i]}_pp.root 
#    cp ./results/output/rawDist_${verName_a[$i]}_splitPD.root ./results/output/rawDist_${verName_side25[$i]}_splitPD.root
#    wait $(jobs -p)
#    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_side25[$i]}'",2,1)' >& log/fitPurity_pbpb_${verName_side25[$i]}.log & sleep 20
#    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_side25[$i]}'",2,1)' >& log/fitPurity_pp_${verName_side25[$i]}.log & sleep 20
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP_temp.C++("'${verName_side25[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_temp_${verName_side25[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
#    python results/RooUnfold_photonRaa_v6.py ${verName_side25[$i]} inv 0 noSplitMC  >& log/RooUnfold_photonRaa_v6_${verName_side25[$i]}.log
#    source /home/goyeonju/root/builddir/bin/thisroot.sh
##    root -l -b -q 'results/drawUnfoldingFigures_v3.C++("'${verName_side25[$i]}'")' >& log/drawUnfoldingFigures_${verName_side25[$i]}.log
#    root -l -b -q 'results/drawRaaXsec_v7_afterUnfolding.C++("'${verName_side25[$i]}'",1)' >& log/drawRaaXsec_v7_afterUnfolding_${verName_side25[$i]}.log
#done
#cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_a}.h ./phoRaaCuts/phoRaaCuts_temp.h
#root -l -b -q 'plotting/photonRaaPlot_withJetphox_v4_temp.C++("'${verName_side25}'")' >& log/plotting_v4_${verName_side25}.log
#
##
#verFileCopy_side26=('190703_temp_v31_sidebandSigEffat85')
#verName_side26=('190703_temp_v31_pur_SBptDep5GeVinterval_v2_ppPtDepCorr_pbpbPtDepCorr_Nfunc0')
#preverName_side26=('190220_temp_v26_nominal')
#for ((i=0; i< ${#verName_side26[@]};i++))
#do
#    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_side26[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#    cp ./efficiency/output/pbpb_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pbpb_iso_efficiency_${verName_side26[$i]}.root
#    cp ./efficiency/output/pp_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pp_iso_efficiency_${verName_side26[$i]}.root
##   cp ./purity/output/purity_pbpb_190703_temp_v31_pur_sidebandSigEffat85_SBcorr_centDep_noPtDep_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pbpb_${verName_side26[$i]}_splitPD_noPreScale.root
##    root -l -b -q 'purity/yj_quickPhotonPurity_v4.C++("pbpb","'${verName_side26[$i]}'",1,0,1,0,50,0)' >& log/yj_quickPhotonPurity_v4_noPreScale_pbpb_${verName_side26[$i]}.log & sleep 20
#####    cp ./purity/output/purity_pp_190703_temp_v31_pur_sidebandSigEffat85_SBcorr_centDep_noPtDep_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pp_${verName_side26[$i]}_splitPD_noPreScale.root
##    root -l -b -q 'purity/yj_quickPhotonPurity_v4.C++("pp","'${verName_side26[$i]}'",1,0,1,0,50,0)' >& log/yj_quickPhotonPurity_v4_noPreScale_pp_${verName_side26[$i]}.log
#    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pbpb.root ./performance/output/correlation_genPt_recoPt_${verName_side26[$i]}_pbpb.root 
#    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pp.root ./performance/output/correlation_genPt_recoPt_${verName_side26[$i]}_pp.root 
#    cp ./results/output/rawDist_${verName_a[$i]}_splitPD.root ./results/output/rawDist_${verName_side26[$i]}_splitPD.root
#    wait $(jobs -p)
#    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_side26[$i]}'",2,1)' >& log/fitPurity_pbpb_${verName_side26[$i]}.log & sleep 20
#    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_side26[$i]}'",2,1)' >& log/fitPurity_pp_${verName_side26[$i]}.log & sleep 20
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP_temp.C++("'${verName_side26[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_temp_${verName_side26[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
#    python results/RooUnfold_photonRaa_v6.py ${verName_side26[$i]} inv 0 noSplitMC  >& log/RooUnfold_photonRaa_v6_${verName_side26[$i]}.log
#    source /home/goyeonju/root/builddir/bin/thisroot.sh
##    root -l -b -q 'results/drawUnfoldingFigures_v3.C++("'${verName_side26[$i]}'")' >& log/drawUnfoldingFigures_${verName_side26[$i]}.log
#    root -l -b -q 'results/drawRaaXsec_v7_afterUnfolding.C++("'${verName_side26[$i]}'",1)' >& log/drawRaaXsec_v7_afterUnfolding_${verName_side26[$i]}.log
#done
#cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_a}.h ./phoRaaCuts/phoRaaCuts_temp.h
#root -l -b -q 'plotting/photonRaaPlot_withJetphox_v4_temp.C++("'${verName_side26}'")' >& log/plotting_v4_${verName_side26}.log


#verFileCopy_side24=('190703_temp_v31_sidebandSigEffat85_v2')
#verName_side24=('190703_temp_v31_pur_SBptDep10GeVinterval_ppPtDepCorr_pbpbPtDepCorr_Nfunc0')
#preverName_side24=('190220_temp_v26_nominal')
#for ((i=0; i< ${#verName_side24[@]};i++))
#do
#    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_side24[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#    cp ./efficiency/output/pbpb_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pbpb_iso_efficiency_${verName_side24[$i]}.root
#    cp ./efficiency/output/pp_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pp_iso_efficiency_${verName_side24[$i]}.root
##   cp ./purity/output/purity_pbpb_190703_temp_v31_pur_sidebandSigEffat85_SBcorr_centDep_noPtDep_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pbpb_${verName_side24[$i]}_splitPD_noPreScale.root
#    root -l -b -q 'purity/yj_quickPhotonPurity_v4.C++("pbpb","'${verName_side24[$i]}'",1,0,1,0,50,0)' >& log/yj_quickPhotonPurity_v4_noPreScale_pbpb_${verName_side24[$i]}.log & sleep 20
##    cp ./purity/output/purity_pp_190703_temp_v31_pur_sidebandSigEffat85_SBcorr_centDep_noPtDep_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pp_${verName_side24[$i]}_splitPD_noPreScale.root
#    root -l -b -q 'purity/yj_quickPhotonPurity_v4.C++("pp","'${verName_side24[$i]}'",1,0,1,0,50,0)' >& log/yj_quickPhotonPurity_v4_noPreScale_pp_${verName_side24[$i]}.log
#    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pbpb.root ./performance/output/correlation_genPt_recoPt_${verName_side24[$i]}_pbpb.root 
#    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pp.root ./performance/output/correlation_genPt_recoPt_${verName_side24[$i]}_pp.root 
#    cp ./results/output/rawDist_${verName_a[$i]}_splitPD.root ./results/output/rawDist_${verName_side24[$i]}_splitPD.root
#    wait $(jobs -p)
#    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_side24[$i]}'",2,1)' >& log/fitPurity_pbpb_${verName_side24[$i]}.log & sleep 20
#    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_side24[$i]}'",2,1)' >& log/fitPurity_pp_${verName_side24[$i]}.log & sleep 20
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP_temp.C++("'${verName_side24[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_temp_${verName_side24[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
#    python results/RooUnfold_photonRaa_v6.py ${verName_side24[$i]} inv 0 noSplitMC  >& log/RooUnfold_photonRaa_v6_${verName_side24[$i]}.log
#    source /home/goyeonju/root/builddir/bin/thisroot.sh
##    root -l -b -q 'results/drawUnfoldingFigures_v3.C++("'${verName_side24[$i]}'")' >& log/drawUnfoldingFigures_${verName_side24[$i]}.log
#    root -l -b -q 'results/drawRaaXsec_v7_afterUnfolding.C++("'${verName_side24[$i]}'",1)' >& log/drawRaaXsec_v7_afterUnfolding_${verName_side24[$i]}.log
#done
#cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_a}.h ./phoRaaCuts/phoRaaCuts_temp.h
#root -l -b -q 'plotting/photonRaaPlot_withJetphox_v4_temp.C++("'${verName_side24}'")' >& log/plotting_v4_${verName_side24}.log
#
##
#verFileCopy_side23=('190703_temp_v31_sidebandSigEffat85')
#verName_side23=('190703_temp_v31_pur_SBptDep5GeVinterval_ppPtDepCorr_pbpbPtDepCorr_Nfunc0')
#preverName_side23=('190220_temp_v26_nominal')
#for ((i=0; i< ${#verName_side23[@]};i++))
#do
#    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_side23[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
...
#    cp ./efficiency/output/pp_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pp_iso_efficiency_${verName_side23[$i]}.root
##   cp ./purity/output/purity_pbpb_190703_temp_v31_pur_sidebandSigEffat85_SBcorr_centDep_noPtDep_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pbpb_${verName_side23[$i]}_splitPD_noPreScale.root
##    root -l -b -q 'purity/yj_quickPhotonPurity_v4.C++("pbpb","'${verName_side23[$i]}'",1,0,1,0,50,0)' >& log/yj_quickPhotonPurity_v4_noPreScale_pbpb_${verName_side23[$i]}.log & sleep 20
#####    cp ./purity/output/purity_pp_190703_temp_v31_pur_sidebandSigEffat85_SBcorr_centDep_noPtDep_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pp_${verName_side23[$i]}_splitPD_noPreScale.root
##    root -l -b -q 'purity/yj_quickPhotonPurity_v4.C++("pp","'${verName_side23[$i]}'",1,0,1,0,50,0)' >& log/yj_quickPhotonPurity_v4_noPreScale_pp_${verName_side23[$i]}.log
#    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pbpb.root ./performance/output/correlation_genPt_recoPt_${verName_side23[$i]}_pbpb.root 
#    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pp.root ./performance/output/correlation_genPt_recoPt_${verName_side23[$i]}_pp.root 
#    cp ./results/output/rawDist_${verName_a[$i]}_splitPD.root ./results/output/rawDist_${verName_side23[$i]}_splitPD.root
#    wait $(jobs -p)
...
#
#verFileCopy_side22=('190703_temp_v31_sidebandSigEffat85_v2')
#verName_side22=('190703_temp_v31_pur_sideband10to20_ppPtDepCorr_pbpbCentDepCorr_Nfunc0')
#preverName_side22=('190220_temp_v26_nominal')
#for ((i=0; i< ${#verName_side22[@]};i++))
#do
#    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_side22[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#    cp ./efficiency/output/pbpb_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pbpb_iso_efficiency_${verName_side22[$i]}.root
#    cp ./efficiency/output/pp_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pp_iso_efficiency_${verName_side22[$i]}.root
#    cp ./purity/output/purity_pbpb_190703_temp_v31_pur_sidebandSigEffat85_SBcorr_centDep_noPtDep_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pbpb_${verName_side22[$i]}_splitPD_noPreScale.root
# #root -l -b -q 'purity/yj_quickPhotonPurity_v4.C++("pbpb","'${verName_side22[$i]}'",1,0,1,0,50,0)' >& log/yj_quickPhotonPurity_v4_noPreScale_pbpb_${verName_side22[$i]}.log & sleep 20
#    cp ./purity/output/purity_pp_190703_temp_v31_pur_sidebandSigEffat85_SBcorr_centDep_noPtDep_Nfunc0_splitPD_noPreScale.root ./purity/output/purity_pp_${verName_side22[$i]}_splitPD_noPreScale.root
#    root -l -b -q 'purity/yj_quickPhotonPurity_v4.C++("pp","'${verName_side22[$i]}'",1,0,1,0,50,0)' >& log/yj_quickPhotonPurity_v4_noPreScale_pp_${verName_side22[$i]}.log
#    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pbpb.root ./performance/output/correlation_genPt_recoPt_${verName_side22[$i]}_pbpb.root 
#    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pp.root ./performance/output/correlation_genPt_recoPt_${verName_side22[$i]}_pp.root 
#    cp ./results/output/rawDist_${verName_a[$i]}_splitPD.root ./results/output/rawDist_${verName_side22[$i]}_splitPD.root
#    wait $(jobs -p)
#    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_side22[$i]}'",2,1)' >& log/fitPurity_pbpb_${verName_side22[$i]}.log & sleep 20
#    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_side22[$i]}'",2,1)' >& log/fitPurity_pp_${verName_side22[$i]}.log & sleep 20
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP_temp.C++("'${verName_side22[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_temp_${verName_side22[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
#    python results/RooUnfold_photonRaa_v6.py ${verName_side22[$i]} inv 0 noSplitMC  >& log/RooUnfold_photonRaa_v6_${verName_side22[$i]}.log
#    source /home/goyeonju/root/builddir/bin/thisroot.sh
##    root -l -b -q 'results/drawUnfoldingFigures_v3.C++("'${verName_side22[$i]}'")' >& log/drawUnfoldingFigures_${verName_side22[$i]}.log
#    root -l -b -q 'results/drawRaaXsec_v7_afterUnfolding.C++("'${verName_side22[$i]}'",1)' >& log/drawRaaXsec_v7_afterUnfolding_${verName_side22[$i]}.log
#done
#cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_a}.h ./phoRaaCuts/phoRaaCuts_temp.h
#root -l -b -q 'plotting/photonRaaPlot_withJetphox_v4_temp.C++("'${verName_side22}'")' >& log/plotting_v4_${verName_side22}.log
#
#
