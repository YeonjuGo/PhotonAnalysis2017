...
#    wait $(jobs -p)
#    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_a[$i]}'",1,1,2)' >& log/fitPurity_pbpb_${verName_a[$i]}_errFuncPol1.log & sleep 20
#    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_a[$i]}'",1,1,2)' >& log/fitPurity_pp_${verName_a[$i]}_errFuncPol1.log & sleep 20
...
##    wait $(jobs -p)
#    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_c[$i]}'",1,1)' >& log/fitPurity_pbpb_${verName_c[$i]}_pol2.log & sleep 20
#    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_c[$i]}'",1,1)' >& log/fitPurity_pp_${verName_c[$i]}_pol2.log & sleep 20
##    wait $(jobs -p)
...
verFileCopy_d=('190703_temp_v31_sys_purDown_more5')
verName_d=('190703_temp_v31_sys_purDown_more5')
preverName_d=('180822_temp_v24_sys_purDown_more5')
...
#    cp ./results/output/rawDist_${verName_a[$i]}_splitPD.root ./results/output/rawDist_${verName_d[$i]}_splitPD.root
    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_d[$i]}'",1,1,2)' >& log/fitPurity_pbpb_${verName_d[$i]}_func2.log & sleep 20
    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_d[$i]}'",1,1,2)' >& log/fitPurity_pp_${verName_d[$i]}_func2.log & sleep 20
...
verFileCopy_d=('190703_temp_v31_sys_purDown_more4')
verName_d=('190703_temp_v31_sys_purDown_more4')
preverName_d=('180822_temp_v24_sys_purDown_more4')
for ((i=0; i< ${#verName_d[@]};i++))
do
#    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_d[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#    cp ./efficiency/output/pbpb_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pbpb_iso_efficiency_${verName_d[$i]}.root
...
verFileCopy_d=('190703_temp_v31_sys_purDown_more3')
verName_d=('190703_temp_v31_sys_purDown_more3')
preverName_d=('180822_temp_v24_sys_purDown_more3')
for ((i=0; i< ${#verName_d[@]};i++))
do
    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_d[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#    cp ./efficiency/output/pbpb_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pbpb_iso_efficiency_${verName_d[$i]}.root
...
verFileCopy_d=('190703_temp_v31_sys_purDown_more2')
verName_d=('190703_temp_v31_sys_purDown_more2')
preverName_d=('180822_temp_v24_sys_purDown_more2')
for ((i=0; i< ${#verName_d[@]};i++))
do
    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_d[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#    cp ./efficiency/output/pbpb_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pbpb_iso_efficiency_${verName_d[$i]}.root
...
verFileCopy_d=('190703_temp_v31_sys_purDown_more')
verName_d=('190703_temp_v31_sys_purDown_more')
preverName_d=('180822_temp_v24_sys_purDown_more')
for ((i=0; i< ${#verName_d[@]};i++))
do
    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_d[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#    cp ./efficiency/output/pbpb_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pbpb_iso_efficiency_${verName_d[$i]}.root
