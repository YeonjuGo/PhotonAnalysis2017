...
#    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_a[$i]}'",1,1)' >& log/fitPurity_pp_${verName_a[$i]}.log & sleep 20
    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_a[$i]}'",1,1,2)' >& log/fitPurity_pbpb_${verName_a[$i]}.log & sleep 20
    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_a[$i]}'",1,1,2)' >& log/fitPurity_pp_${verName_a[$i]}.log & sleep 20
    wait $(jobs -p)
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3.C++("pbpb","'${verName_dmore5[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_pbpb_${verName_dmore5[$i]}.log & sleep 20
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3.C++("pp","'${verName_dmore5[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_pp_${verName_dmore5[$i]}.log
#    wait $(jobs -p)
...
#    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_dmore5[$i]}'",1,1)' >& log/fitPurity_pp_${verName_dmore5[$i]}.log & sleep 20
    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_dmore5[$i]}'",1,1,2)' >& log/fitPurity_pbpb_${verName_dmore5[$i]}.log & sleep 20
    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_dmore5[$i]}'",1,1,2)' >& log/fitPurity_pp_${verName_dmore5[$i]}.log & sleep 20
    wait $(jobs -p)
    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP.C++("'${verName_dmore5[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_${verName_dmore5[$i]}.log
    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
#    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_dmore4[$i]}'",1,1)' >& log/fitPurity_pp_${verName_dmore4[$i]}.log & sleep 20
    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_dmore4[$i]}'",1,1,2)' >& log/fitPurity_pbpb_${verName_dmore4[$i]}.log & sleep 20
    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_dmore4[$i]}'",1,1,2)' >& log/fitPurity_pp_${verName_dmore4[$i]}.log & sleep 20
    wait $(jobs -p)
    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP.C++("'${verName_dmore4[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_${verName_dmore4[$i]}.log
    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
##    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_dmore3[$i]}'",1,1)' >& log/fitPurity_pp_${verName_dmore3[$i]}.log & sleep 20
    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_dmore3[$i]}'",1,1,2)' >& log/fitPurity_pbpb_${verName_dmore3[$i]}.log & sleep 20
    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_dmore3[$i]}'",1,1,2)' >& log/fitPurity_pp_${verName_dmore3[$i]}.log & sleep 20
    wait $(jobs -p)
    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP.C++("'${verName_dmore3[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_${verName_dmore3[$i]}.log
    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
##    cp ./results/output/rawDist_${verName_a[$i]}_splitPD.root ./results/output/rawDist_${verName_dmore2[$i]}_splitPD.root
    ...
    wait $(jobs -p)
    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP.C++("'${verName_dmore2[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_${verName_dmore2[$i]}.log
    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
##    cp ./results/output/rawDist_${verName_a[$i]}_splitPD.root ./results/output/rawDist_${verName_dmore[$i]}_splitPD.root
    ...
    wait $(jobs -p)
    root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP.C++("'${verName_dmore[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_${verName_dmore[$i]}.log
    source /data/ROOT-v5.34.21/bin/thisroot.sh
...
###    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_d[$i]}'",1,1)' >& log/fitPurity_pp_${verName_d[$i]}.log & sleep 20
    root -l -b -q 'purity/fitPurity.C++("pbpb","'${verName_d[$i]}'",1,1,2)' >& log/fitPurity_pbpb_${verName_d[$i]}.log & sleep 20
    root -l -b -q 'purity/fitPurity.C++("pp","'${verName_d[$i]}'",1,1,2)' >& log/fitPurity_pp_${verName_d[$i]}.log & sleep 20
    wait $(jobs -p)
...
##        wait $(jobs -p)
###        root -l -b -q 'results/drawRaaXsec_v7_beforeUnfolding_withTnP_withTnP.C++("'${verName_tnp[$i]}'",1)' >& log/drawRaaXsec_v7_beforeUnfolding_withTnP_withTnP_${verName_tnp[$i]}.log
##        source /data/ROOT-v5.34.21/bin/thisroot.sh
