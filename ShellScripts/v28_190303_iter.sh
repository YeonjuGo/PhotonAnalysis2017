...
verFileCopy_a=('190303_temp_v28')
verName_a=('190303_temp_v28_nominal')
...
#    python results/RooUnfold_photonRaa_v4.py ${verName_a[$i]} bin noSplitMC >& log/RooUnfold_photonRaa_v4_${verName_a[$i]}.log
...
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
#    python results/RooUnfold_photonRaa_v4.py ${verName_a[$i]} bin splitMC >& log/RooUnfold_photonRaa_v4_${verName_a[$i]}_splitMC.log
#    source /home/goyeonju/root/builddir/bin/thisroot.sh
#    root -l -b -q 'results/drawUnfoldingFigures.C++("'${verName_a[$i]}'",1)' >& log/drawUnfoldingFigures_${verName_a[$i]}_splitMC.log
...
verName_l=('190303_temp_v28_sys_unfolding_svd')
...
#    cp ./results/output/phoRaa_${verName_a[$i]}_beforeUnfolding.root ./results/output/phoRaa_${verName_l[$i]}_beforeUnfolding.root
    source /data/ROOT-v5.34.21/bin/thisroot.sh
    python results/RooUnfold_photonRaa_v4.py ${verName_l[$i]} svd noSplitMC  >& log/RooUnfold_photonRaa_v4_${verName_l[$i]}.log
    source /home/goyeonju/root/builddir/bin/thisroot.sh
    ...
    source /data/ROOT-v5.34.21/bin/thisroot.sh
    python results/RooUnfold_photonRaa_v4.py ${verName_l[$i]} svd splitMC >& log/RooUnfold_photonRaa_v4_${verName_l[$i]}_splitMC.log
    source /home/goyeonju/root/builddir/bin/thisroot.sh
    root -l -b -q 'results/drawUnfoldingFigures.C++("'${verName_l[$i]}'",1)' >& log/drawUnfoldingFigures_${verName_l[$i]}_splitMC.log
...
#        source /data/ROOT-v5.34.21/bin/thisroot.sh
#        python results/RooUnfold_photonRaa_v4.py ${verName_m[$i]} $j noSplitMC  >& log/RooUnfold_photonRaa_v4_${verName_m[$i]}.log
#        source /home/goyeonju/root/builddir/bin/thisroot.sh
...
#        source /data/ROOT-v5.34.21/bin/thisroot.sh
#        python results/RooUnfold_photonRaa_v4.py ${verName_m[$i]} $j splitMC >& log/RooUnfold_photonRaa_v4_${verName_m[$i]}_splitMC.log
#        source /home/goyeonju/root/builddir/bin/thisroot.sh
#        root -l -b -q 'results/drawUnfoldingFigures.C++("'${verName_m[$i]}'",1)' >& log/drawUnfoldingFigures_${verName_m[$i]}.log
...
##    root -l -b -q 'purity/yj_quickPhotonPurity_v2.C++("pbpb","'${verName_c[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v2_pbpb_${verName_c[$i]}.log & sleep 20
...
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
#    python results/RooUnfold_photonRaa_v4.py ${verName_c[$i]} 6 noSplitMC  >& log/RooUnfold_photonRaa_v4_${verName_c[$i]}.log
#    source /home/goyeonju/root/builddir/bin/thisroot.sh
...
verName_hhh=('190303_temp_v28_sys_eff')
for ((i=0; i< ${#verName_hhh[@]};i++))
do
    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_hhh[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#    cp ./efficiency/output/pbpb_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pbpb_iso_efficiency_${verName_hhh[$i]}.root
#    cp ./efficiency/output/pp_iso_efficiency_${verName_a[$i]}.root ./efficiency/output/pp_iso_efficiency_${verName_hhh[$i]}.root
#    cp ./purity/output/purity_pbpb_${verName_a[$i]}_splitPD.root ./purity/output/purity_pbpb_${verName_hhh[$i]}_splitPD.root
#    cp ./purity/output/purity_pp_${verName_a[$i]}_splitPD.root ./purity/output/purity_pp_${verName_hhh[$i]}_splitPD.root
#    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pbpb.root ./performance/output/correlation_genPt_recoPt_${verName_hhh[$i]}_pbpb.root 
#    cp ./performance/output/correlation_genPt_recoPt_${verName_a[$i]}_pp.root ./performance/output/correlation_genPt_recoPt_${verName_hhh[$i]}_pp.root 
#    cp ./results/output/rawDist_${verName_a[$i]}_splitPD.root ./results/output/rawDist_${verName_hhh[$i]}_splitPD.root
#    root -l -b -q 'results/drawRaaXsec_withTnP.C++("'${verName_hhh[$i]}'")' >& log/drawRaaXsec_withTnP_${verName_hhh[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
#    python results/RooUnfold_photonRaa_v4.py ${verName_hhh[$i]} 6 noSplitMC  >& log/RooUnfold_photonRaa_v4_${verName_hhh[$i]}.log
#    source /home/goyeonju/root/builddir/bin/thisroot.sh
#    root -l -b -q 'results/drawUnfoldingFigures.C++("'${verName_hhh[$i]}'")' >& log/drawUnfoldingFigures_${verName_hhh[$i]}.log
...
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
#    python results/RooUnfold_photonRaa_v4.py ${verName_d[$i]} 6 noSplitMC  >& log/RooUnfold_photonRaa_v4_${verName_d[$i]}.log
#    source /home/goyeonju/root/builddir/bin/thisroot.sh
...
verName_f=('190303_temp_v28_sys_IDup')
...
##    root -l -b -q 'efficiency/iso_efficiency_withSkimFile_v2.C++("pbpb","'${verName_f[$i]}'")' >& log/efficiency_withSkimFile_v2_pbpb_${verName_f[$i]}.log & sleep 10
##    root -l -b -q 'efficiency/iso_efficiency_withSkimFile_v2.C++("pp","'${verName_f[$i]}'")' >& log/efficiency_withSkimFile_v2_pp_${verName_f[$i]}.log & sleep 10
#    root -l -b -q 'purity/yj_quickPhotonPurity_v2.C++("pbpb","'${verName_f[$i]}'",1,0,0)' >& log/yj_quickPhotonPurity_v2_pbpb_${verName_f[$i]}.log & sleep 10
#    root -l -b -q 'purity/yj_quickPhotonPurity_v2.C++("pp","'${verName_f[$i]}'",1,0,0)' >& log/yj_quickPhotonPurity_v2_pp_${verName_f[$i]}.log & sleep 10
##    root -l -b -q 'performance/correlation_genPt_recoPt.C++("pbpb","'${verName_f[$i]}'")' >& log/correlation_pbpb_${verName_f[$i]}.log & sleep 10
##    root -l -b -q 'performance/correlation_genPt_recoPt.C++("pp","'${verName_f[$i]}'")' >& log/correlation_pp_${verName_f[$i]}.log & sleep 10
##    root -l -b -q 'results/getRawDist_v6.C++("'${verName_f[$i]}'",1,0)' >& log/getRawDist_v6_${verName_f[$i]}.log & sleep 10
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v6.C++("'${verName_f[$i]}'",0)' >& log/drawRaaXsec_v6_${verName_f[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
#    python results/RooUnfold_photonRaa_v4.py ${verName_f[$i]} 6 noSplitMC  >& log/RooUnfold_photonRaa_v4_${verName_f[$i]}.log
#    source /home/goyeonju/root/builddir/bin/thisroot.sh
...
#verName_fa=('190303_temp_v28_sys_IDdown')
...
#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile_v2.C++("pbpb","'${verName_fa[$i]}'")' >& log/efficiency_withSkimFile_v2_pbpb_${verName_fa[$i]}.log & sleep 10
#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile_v2.C++("pp","'${verName_fa[$i]}'")' >& log/efficiency_withSkimFile_v2_pp_${verName_fa[$i]}.log & sleep 10
#    root -l -b -q 'purity/yj_quickPhotonPurity_v2.C++("pbpb","'${verName_fa[$i]}'",1,0,0)' >& log/yj_quickPhotonPurity_v2_pbpb_${verName_fa[$i]}.log & sleep 10
#    root -l -b -q 'purity/yj_quickPhotonPurity_v2.C++("pp","'${verName_fa[$i]}'",1,0,0)' >& log/yj_quickPhotonPurity_v2_pp_${verName_fa[$i]}.log & sleep 10
#    root -l -b -q 'performance/correlation_genPt_recoPt.C++("pbpb","'${verName_fa[$i]}'")' >& log/correlation_pbpb_${verName_fa[$i]}.log & sleep 10
#    root -l -b -q 'performance/correlation_genPt_recoPt.C++("pp","'${verName_fa[$i]}'")' >& log/correlation_pp_${verName_fa[$i]}.log & sleep 10
#    root -l -b -q 'results/getRawDist_v6.C++("'${verName_fa[$i]}'",1,0)' >& log/getRawDist_v6_${verName_fa[$i]}.log & sleep 10
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v6.C++("'${verName_fa[$i]}'",0)' >& log/drawRaaXsec_v6_${verName_fa[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
#    python results/RooUnfold_photonRaa_v4.py ${verName_fa[$i]} 6 noSplitMC  >& log/RooUnfold_photonRaa_v4_${verName_fa[$i]}.log
#    source /home/goyeonju/root/builddir/bin/thisroot.sh
...
#verName_b=('190303_temp_v28_sys_phoEscale')
...
#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile_v2.C++("pbpb","'${verName_b[$i]}'")' >& log/efficiency_withSkimFile_v2_pbpb_${verName_b[$i]}.log & sleep 10
#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile_v2.C++("pp","'${verName_b[$i]}'")' >& log/efficiency_withSkimFile_v2_pp_${verName_b[$i]}.log & sleep 10
#    root -l -b -q 'purity/yj_quickPhotonPurity_v2.C++("pbpb","'${verName_b[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v2_pbpb_${verName_b[$i]}.log & sleep 10
#    root -l -b -q 'purity/yj_quickPhotonPurity_v2.C++("pp","'${verName_b[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v2_pp_${verName_b[$i]}.log & sleep 10
#    root -l -b -q 'performance/correlation_genPt_recoPt.C++("pbpb","'${verName_b[$i]}'")' >& log/correlation_pbpb_${verName_b[$i]}.log & sleep 10
#    root -l -b -q 'performance/correlation_genPt_recoPt.C++("pp","'${verName_b[$i]}'")' >& log/correlation_pp_${verName_b[$i]}.log & sleep 10
#    root -l -b -q 'results/getRawDist_v6.C++("'${verName_b[$i]}'",1,1)' >& log/getRawDist_v6_${verName_b[$i]}.log & sleep 10
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v6.C++("'${verName_b[$i]}'",1)' >& log/drawRaaXsec_v6_${verName_b[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
#    python results/RooUnfold_photonRaa_v4.py ${verName_b[$i]} 6 noSplitMC  >& log/RooUnfold_photonRaa_v4_${verName_b[$i]}.log
#    source /home/goyeonju/root/builddir/bin/thisroot.sh
...
#verName_j=('190303_temp_v28_sys_phoEresol')
#for ((i=0; i< ${#verName_j[@]};i++))
#do
#    cp ./phoRaaCuts/phoRaaCuts_${verFileCopy_j[$i]}.h ./phoRaaCuts/phoRaaCuts_temp.h
#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile_v2.C++("pbpb","'${verName_j[$i]}'")' >& log/efficiency_withSkimFile_v2_pbpb_${verName_j[$i]}.log & sleep 10
#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile_v2.C++("pp","'${verName_j[$i]}'")' >& log/efficiency_withSkimFile_v2_pp_${verName_j[$i]}.log & sleep 10
#    root -l -b -q 'purity/yj_quickPhotonPurity_v2.C++("pbpb","'${verName_j[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v2_pbpb_${verName_j[$i]}.log & sleep 10
#    root -l -b -q 'purity/yj_quickPhotonPurity_v2.C++("pp","'${verName_j[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v2_pp_${verName_j[$i]}.log & sleep 10
#    root -l -b -q 'performance/correlation_genPt_recoPt.C++("pbpb","'${verName_j[$i]}'")' >& log/correlation_pbpb_${verName_j[$i]}.log & sleep 10
#    root -l -b -q 'performance/correlation_genPt_recoPt.C++("pp","'${verName_j[$i]}'")' >& log/correlation_pp_${verName_j[$i]}.log & sleep 10
#    root -l -b -q 'results/getRawDist_v6.C++("'${verName_j[$i]}'")' >& log/getRawDist_v6_${verName_j[$i]}.log & sleep 10
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v6.C++("'${verName_j[$i]}'")' >& log/drawRaaXsec_v6_${verName_j[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
#    python results/RooUnfold_photonRaa_v4.py ${verName_j[$i]} 6 noSplitMC  >& log/RooUnfold_photonRaa_v4_${verName_j[$i]}.log
#    source /home/goyeonju/root/builddir/bin/thisroot.sh
...
#verName_e=('190303_temp_v28_sys_eleCont')
...
#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile_v2.C++("pbpb","'${verName_e[$i]}'")' >& log/efficiency_withSkimFile_v2_pbpb_${verName_e[$i]}.log & sleep 10
#    root -l -b -q 'efficiency/iso_efficiency_withSkimFile_v2.C++("pp","'${verName_e[$i]}'")' >& log/efficiency_withSkimFile_v2_pp_${verName_e[$i]}.log & sleep 10
#    root -l -b -q 'purity/yj_quickPhotonPurity_v2.C++("pbpb","'${verName_e[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v2_pbpb_${verName_e[$i]}.log & sleep 10
#    root -l -b -q 'purity/yj_quickPhotonPurity_v2.C++("pp","'${verName_e[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v2_pp_${verName_e[$i]}.log & sleep 10
#    root -l -b -q 'performance/correlation_genPt_recoPt.C++("pbpb","'${verName_e[$i]}'")' >& log/correlation_pbpb_${verName_e[$i]}.log & sleep 10
#    root -l -b -q 'performance/correlation_genPt_recoPt.C++("pp","'${verName_e[$i]}'")' >& log/correlation_pp_${verName_e[$i]}.log & sleep 10
#    root -l -b -q 'results/getRawDist_v6.C++("'${verName_e[$i]}'",1,1)' >& log/getRawDist_v6_${verName_e[$i]}.log & sleep 10
#    wait $(jobs -p)
#    root -l -b -q 'results/drawRaaXsec_v6.C++("'${verName_e[$i]}'",1)' >& log/drawRaaXsec_v6_${verName_e[$i]}.log
#    source /data/ROOT-v5.34.21/bin/thisroot.sh
#    python results/RooUnfold_photonRaa_v4.py ${verName_e[$i]} 6 noSplitMC  >& log/RooUnfold_photonRaa_v4_${verName_e[$i]}.log
#    source /home/goyeonju/root/builddir/bin/thisroot.sh
...
#verName_h=('190303_temp_v28_sys_TAAup')
...
#verName_ha=('190303_temp_v28_sys_TAAdown')
