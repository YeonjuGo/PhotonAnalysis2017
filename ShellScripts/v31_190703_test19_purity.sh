...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3.C++("pbpb","'${verName_a[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_pbpb_${verName_a[$i]}.log & sleep 20
    root -l -b -q 'purity/yj_quickPhotonPurity_v3.C++("pbpb","'${verName_a[$i]}'",1,1,0,0,1)' >& log/yj_quickPhotonPurity_v3_pbpb_${verName_a[$i]}_bkgMC.log & sleep 20
...
#    root -l -b -q 'purity/yj_quickPhotonPurity_v3.C++("pp","'${verName_a[$i]}'",1,1)' >& log/yj_quickPhotonPurity_v3_pp_${verName_a[$i]}.log & sleep 20
    root -l -b -q 'purity/yj_quickPhotonPurity_v3.C++("pp","'${verName_a[$i]}'",1,1,0,0,1)' >& log/yj_quickPhotonPurity_v3_pp_${verName_a[$i]}_bkgMC.log & sleep 20
