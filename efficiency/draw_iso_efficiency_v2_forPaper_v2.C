...
// 2019July25) unfolding binning (20 GeV to 300 GeV) 
...
void draw_iso_efficiency_v2_forPaper_v2(TString coll="pp", TString ver="190703_temp_v31_nominal", bool doWeight=true, bool doBkg=false, bool doSeparation=true){
