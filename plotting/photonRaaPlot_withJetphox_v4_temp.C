...
void photonRaaPlot_withJetphox_v4_temp(TString ver="190703_temp_v31", bool doJETPHOX = true) {
    ...
    const std::string input_file = Form("%sresults/output/phoRaa_afterUnfolding_%s.root",dir.Data(),ver.Data());
    const std::string sys_file = Form("%ssystematics/output/systematics_%s.root",dir.Data(),"190703_temp_v31");
