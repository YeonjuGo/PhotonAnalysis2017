...
void photonRaaPlot_withJetphox_v2(TString ver="190703_temp_v31_eleContTest", bool doJETPHOX = true) {
    ...
    ///// scale 1.0
    TFile* fdir_pp = TFile::Open("/home/samba.old/jaebeom/ForYeonju/Nominal1B/ggdpp_CT14nlo_nominal_scale1_190719.root","read");
    TFile* fonef_pp = TFile::Open("/home/samba.old/jaebeom/ForYeonju/Nominal1B/ggopp_CT14nlo_nominal_scale1_190719.root","read");
    TFile* fdir_pbpb = TFile::Open("/home/samba.old/jaebeom/ForYeonju/Nominal1B/ggdPbPb_EPPS16nlo_CT14nlo_Pb208_nominal_scale_190716.root","read");
    TFile* fonef_pbpb = TFile::Open("/home/samba.old/jaebeom/ForYeonju/Nominal1B/ggoPbPb_EPPS16nlo_CT14nlo_Pb208_nominal_scale_190716.root","read");
    ///// scale 0.5
    //TFile* fdir_pp = TFile::Open("/home/samba.old/jaebeom/ForYeonju/Nominal1B/ggdpp_CT14nlo_1B_cd.root","read");
    //TFile* fonef_pp = TFile::Open("/home/samba.old/jaebeom/ForYeonju/Nominal1B/ggopp_CT14nlo_1B_cd.root","read");
    //TFile* fdir_pbpb = TFile::Open("/home/samba.old/jaebeom/ForYeonju/Nominal1B/ggdPbPb_EPPS16nlo_CT14nlo_Pb208_1B.root","read");
    //TFile* fonef_pbpb = TFile::Open("/home/samba.old/jaebeom/ForYeonju/Nominal1B/ggoPbPb_EPPS16nlo_CT14nlo_Pb208_1B.root","read");
    TFile* fdir_pbpb_nCTEQ = TFile::Open("/home/samba.old/jaebeom/ForYeonju/Nominal1B/ggdPbPb_nCTEQ15_208_82_1B.root","read");
    TFile* fonef_pbpb_nCTEQ = TFile::Open("/home/samba.old/jaebeom/ForYeonju/Nominal1B/ggoPbPb_nCTEQ15_208_82_1B.root","read");
    ...
    //TFile* fsys_pbpb = TFile::Open("/home/samba.old/jaebeom/ForYeonju/Sys_PbPb_EPPS16nlo_CT14nlo_Pb208.root","read");
    //jTFile* fdir_pp = TFile::Open("/home/samba.old/jaebeom/ForYeonju/ggd_2test_pp_CT14nlo_true.root","read");
    //TFile* fonef_pp = TFile::Open("/home/samba.old/jaebeom/ForYeonju/ggo_2test_pp_CT14nlo_true.root","read");
    //TFile* fdir_pp = TFile::Open("/home/samba.old/jaebeom/ForYeonju/190703/ggdpp_nominal_CT14nlo_0.root","read");
    //TFile* fonef_pp = TFile::Open("/home/samba.old/jaebeom/ForYeonju/190703/ggopp_nominal_CT14nlo_0.root","read");
    //TFile* fdir_pp = TFile::Open("/home/samba.old/jaebeom/ForYeonju/ggdpp_CT14nlo_10M.root","read");
    //TFile* fonef_pp = TFile::Open("/home/samba.old/jaebeom/ForYeonju/ggopp_CT14nlo_10M.root","read");
    //TFile* fdir_pbpb = TFile::Open("/home/samba.old/jaebeom/ForYeonju/190703/ggdEPPS16nlo_CT14nlo_Pb208_0.root","read");
    //TFile* fonef_pbpb = TFile::Open("/home/samba.old/jaebeom/ForYeonju/190703/ggoEPPS16nlo_CT14nlo_Pb208_0.root","read");
    ...
    TH1D* h1D_jp[3][2][3];//[0:dir, 1:onef, 2:inclusive] [0:Leading Order, 1:Next-to-Leading Order] [0:pbpb, 1:pp, 2:nCTEQ]
    TH1D* TF1[3][2][3];//[0:dir, 1:onef, 2:inclusive] [0:Leading Order, 1:Next-to-Leading Order] [0:pbpb, 1:pp, 2:nCTEQ]
    // direct contribution
    ...
    h1D_jp[0][0][2] = (TH1D*) fdir_pbpb_nCTEQ->Get("hp40");
    h1D_jp[0][0][2]->SetName("jp_dir_lo_pbpb_nCTEQ");
    h1D_jp[0][1][2] = (TH1D*) fdir_pbpb_nCTEQ->Get("hp41");
    h1D_jp[0][1][2]->SetName("jp_dir_nlo_pbpb_nCTEQ");
    ...
    h1D_jp[1][0][2] = (TH1D*) fonef_pbpb_nCTEQ->Get("hp40");
    h1D_jp[1][0][2]->SetName("jp_onef_lo_pbpb_nCTEQ");
    h1D_jp[1][1][2] = (TH1D*) fonef_pbpb_nCTEQ->Get("hp41");
    h1D_jp[1][1][2]->SetName("jp_onef_nlo_pbpb_nCTEQ");
    ...
    h1D_jp[2][0][2] = (TH1D*) h1D_jp[1][0][2]->Clone("jp_inclusive_lo_pbpb_nCTEQ");
    h1D_jp[2][0][2]->Add(h1D_jp[0][0][2]);
    h1D_jp[2][1][2] = (TH1D*) h1D_jp[1][1][2]->Clone("jp_inclusive_nlo_pbpb_nCTEQ");
    h1D_jp[2][1][2]->Add(h1D_jp[0][1][2]);
    ...
    for(int icoll=0;icoll<3;++icoll){
        ...
        if(icoll==0){ 
            h1D_jp[icont][ior][0]->SetLineColor(2);
            h1D_jp[icont][ior][0]->SetLineStyle(6);
        } else{ 
            h1D_jp[icont][ior][icoll]->SetLineColor(1);
            h1D_jp[icont][ior][icoll]->SetLineStyle(2);
        }
    ...
    for(int icoll=0;icoll<3;++icoll){
        for (int k=0; k<nCentBinIF; ++k) { //k=0 is 0-100 % 
            hjp_draw_dndpt[icoll][k] = (TH1D*) h1D_jp[2][1][icoll]->Clone(Form("hjp_draw%d_%d",k,icoll));//onef+dir
    ...
    //final for raa
    TH1D* hjp_draw_raa[2];
    hjp_draw_raa[0] = (TH1D*) h1D_jp[2][1][0]->Clone("jp_inclusive_nlo_raa"); //only for inclusive, next-to-leading order 
    hjp_draw_raa[1] = (TH1D*) h1D_jp[2][1][2]->Clone("jp_inclusive_nlo_raa_nCTEQ"); //only for inclusive, next-to-leading order 
    hjp_draw_raa[0]->Divide(h1D_jp[2][1][1]);
    hjp_draw_raa[1]->Divide(h1D_jp[2][1][1]);
    ...
    for(int ipt=0; ipt<h1D_jp[2][1][0]->GetNbinsX();++ipt)
        cout << "ipt = " << ipt << ", bin val = " <<  h1D_jp[2][1][0]->GetBinContent(ipt+1) << ", bin error = " << h1D_jp[2][1][0]->GetBinError(ipt+1)<< endl;;
    cout << "pp CT14 JETPHOX error " << endl;
    for(int ipt=0; ipt<h1D_jp[2][1][1]->GetNbinsX();++ipt)
        cout << "ipt = " << ipt  << ", bin val = " <<  h1D_jp[2][1][1]->GetBinContent(ipt+1) << ", bin error = " << h1D_jp[2][1][1]->GetBinError(ipt+1)<< endl;;
    ...
    for (int k=0; k<nCentBinIF; ++k) { //k=0 is 0-100 % 
        ...
        ratio_data_jp[k]->SetTitle(";Photon E_{T} (GeV);DATA / JETPHOX (EPPS16 CT14 nlo) ");
    }
    ...
    htemp[1]->SetTitle(";photon E_{T} GeV;DATA / JETPHOX nlo");
    htemp[1]->DrawCopy("p");
    ...
    for (int k=0; k<nCentBinIF; ++k) { //k=0 is 0-100 % 
        ...
        htemp[1]->SetTitle(";Photon E_{T} (GeV/c);DATA / JETPHOX (EPPS16+CT14 NLO)");
        htemp[1]->DrawCopy("p");
        gr_sys_ratio[k]->Draw("2");
        gr_ratio[k]->Draw("P");
        jumSun(ptBins[0],1,ptBins[nPtBin],1);
    ...
    htemp[1]->SetTitle(";Photon E_{T} (GeV/c);DATA / JETPHOX (CT14 NLO)");
    htemp[1]->DrawCopy("p");
    gr_sys_ratio_pp->Draw("2");
    gr_ratio_pp->Draw("P");
    ...
    h1D_sys_jetphox_pbpb = (TH1D*) fsys_pbpb->Get("h_nom");
