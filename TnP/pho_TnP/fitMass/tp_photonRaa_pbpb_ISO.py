...
process.tagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    # IO parameters:
    InputFileNames = cms.vstring("file:/afs/cern.ch/work/i/ikucher/TnP_EG/photonRaa/output_%s_PbPb_massRange.root" % dataOrMC),
    InputDirectoryName = cms.string("phoTree"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("tnp_Ana_%s_%s_%s_newTree_ISO.root" % ( dataOrMC, type, PDFName )),
    ...
    Variables = cms.PSet(
                         ...
                         probe_pt               = cms.vstring("Probe p_{T}", "40.0", "120.0", "GeV/c"),
