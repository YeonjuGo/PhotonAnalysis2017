...
void fillTreeTnP_pp_v8_etaphi_noSC() {
...
#ifdef MC
   TFile *fout = new TFile("output_mc_pp_v8_etaphi_noSC.root","RECREATE");
#else
   TFile *fout = new TFile("output_data_pp_v8_etaphi_noSC.root","RECREATE");
#endif
