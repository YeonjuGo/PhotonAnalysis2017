...
#invertMatrix = []
#condNum = ROOT.InvertMatrix(h2d_list_pp[-1], invertMatrix)
...
for res in RooUnfold_res_pp:
    RooUnfold_pp.append(ROOT.RooUnfold(res,reco_list_pp[-1]))
    resMat.append(res.Mresponse())
    #RooUnfold_pp.Wreco(3)

for res in RooUnfold_pp:
  condNum.append(res.InvertMatrix(resMat[-1],invMat[-1]))
...
for res in RooUnfold_rd:
  ...
  #resMat = res.Mresponse()
  #condNum = ROOT.InvertMatrix(h2d_list_pp[-1], invertMatrix)
  #print "condition number"
  #print condNum
  #resMat = res.Mresponse()
  #invertMatrix = resMat.Wreco(3) 
  #pearsonCoefs.SetName(tempCov.GetName()+"_pearsonCoefsMatrix")
