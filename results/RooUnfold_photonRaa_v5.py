...
for res in RooUnfold_mc_nm:
  ...
  tmpm = res.Ereco(e_opt)
  covMatrix_mc_nm.append(tmpm.Clone(tmpm.GetName()+"_covMatrix_mc_nm"))
...
for res in RooUnfold_rd:
  ...
  tmpm = res.Ereco(e_opt)
  covMatrix_rd.append(tmpm.Clone(tmpm.GetName()+"_covMatrix_rd"))
...
for res in RooUnfold_mc_pp:
  ...
  tmpm = res.Ereco(e_opt)
  covMatrix_mc_pp.append(tmpm.Clone(tmpm.GetName()+"_covMatrix_mc_pp"))
...
for res in RooUnfold_mc_nm_pp:
  ...
  tmpm = res.Ereco(e_opt)
  covMatrix_mc_nm_pp.append(tmpm.Clone(tmpm.GetName()+"_covMatrix_mc_nm_pp"))
...
for res in RooUnfold_rd_pp:
  ...
  tmpm = res.Ereco(e_opt)
  covMatrix_rd_pp.append(tmpm.Clone(tmpm.GetName()+"_covMatrix_rd_pp"))
