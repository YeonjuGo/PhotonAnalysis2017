...
void drawRaaXsec_v5_makeOutput(TString ver="180731_temp_v19_nominal", bool doSplitPD = true,  bool purityTest = false)
{
    TH1::SetDefaultSumw2();
    ...
    TFile* f_out = new TFile(Form("/home/goyeonju/CMS/2017/PhotonAnalysis2017/results/output/phoRaa_%s.root",ver.Data()));
