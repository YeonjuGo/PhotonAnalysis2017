...
void test(TString ver="test_4", bool doPreScale=true, bool doSplitPD=true)
{
    ...
    for(int j=0;j<nCentBinIF;j++){
        ...
        if(doSplitPD){
            if(doPreScale){
                ...
                tpbpb->Draw(Form("%s>>%s",phoEtVar.Data(),h1D_raw_temp_early[j]->GetName()), Form("HLT_HISinglePhoton20_Eta1p5_v1_Prescl * L1_MinimumBiasHF1_AND_Prescl*(HLT_HISinglePhoton20_Eta1p5_v1 && (run >=262620 && run <=263035) && %s && %s && %s && %s)", phoSignalCut_woTrig.GetTitle(), centCut.GetTitle(), etaCut.GetTitle(), ptSplitCut[0].GetTitle()));
                tpbpb->Draw(Form("%s>>%s",phoEtVar.Data(),h1D_raw_temp_late[j]->GetName()), Form("HLT_HISinglePhoton20_Eta1p5_v2_Prescl * L1_MinimumBiasHF2_AND_Prescl*(L1_MinimumBiasHF2_AND_Prescl<500 && HLT_HISinglePhoton20_Eta1p5_v2 && (run >= 263233 && run <= 263614) && %s && %s && %s && %s)", phoSignalCut_woTrig.GetTitle(), centCut.GetTitle(), etaCut.GetTitle(), ptSplitCut[0].GetTitle()));
            ...
            if(doPreScale){
                ...
                tpbpb->Draw(Form("%s>>%s",phoEtVar.Data(),h1D_raw_temp_early[j]->GetName()), Form("HLT_HISinglePhoton20_Eta1p5_v1_Prescl * L1_MinimumBiasHF1_AND_Prescl*(HLT_HISinglePhoton20_Eta1p5_v1 && (run >=262620 && run <=263035) && %s && %s && %s)", phoSignalCut_woTrig.GetTitle(), centCut.GetTitle(), etaCut.GetTitle()));
                tpbpb->Draw(Form("%s>>%s",phoEtVar.Data(),h1D_raw_temp_late[j]->GetName()), Form("HLT_HISinglePhoton20_Eta1p5_v2_Prescl * L1_MinimumBiasHF2_AND_Prescl*(L1_MinimumBiasHF2_AND_Prescl<500 && HLT_HISinglePhoton20_Eta1p5_v2 &&  (run >=263233 && run <=263614) && %s && %s && %s)", phoSignalCut_woTrig.GetTitle(), centCut.GetTitle(), etaCut.GetTitle()));
    ...
    if(doSplitPD){
        ...
        if(doPreScale){
            tpp->Draw(Form("%s>>%s",phoEtVar.Data(),h1D_rawpp->GetName()), Form("HLT_HISinglePhoton20_Eta1p5_v1_Prescl*(%s && %s && %s)", trigCut_pp_low.GetTitle(), phoSignalCut_woTrig_pp.GetTitle(), etaCut.GetTitle())); 
