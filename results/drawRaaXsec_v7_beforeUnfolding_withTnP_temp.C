...
void drawRaaXsec_v7_beforeUnfolding_withTnP_temp(TString ver="190703_temp_v31_pur_SBcorr_centDep", bool doSplitPD = true, int nIter = 3, bool doPreScale = false, bool usePurityFit = true)
{
    TH1::SetDefaultSumw2();
    ...
    // v4_ without prescale correction
    //TFile* f_pur = new TFile(Form("/home/goyeonju/CMS/2017/PhotonAnalysis2017/purity/output/purity_v4_withFunc_pbpb_%s%s.root",ver.Data(),cap.Data()));
    //TFile* f_purpp = new TFile(Form("/home/goyeonju/CMS/2017/PhotonAnalysis2017/purity/output/purity_v4_withFunc_pp_%s%s.root",ver.Data(),cap.Data()));
    // v3_ without prescale correction
    ...
    //TFile* f_pur = new TFile(Form("/home/goyeonju/CMS/2017/PhotonAnalysis2017/purity/output/purity_withFunc_pbpb_%s%s_iter%d.root",ver.Data(),cap_pur.Data(),nIter));
    //TFile* f_purpp = new TFile(Form("/home/goyeonju/CMS/2017/PhotonAnalysis2017/purity/output/purity_withFunc_pp_%s%s_iter%d.root",ver.Data(),cap_pur.Data(),nIter));
    // v3_ with prescale correction
    ...
    for(int j=0;j<nCentBinIF;++j)
    {
       ...
       // h1D_eff[j]->Draw();
        ...
        fit_pur[j] = (TF1*) f_pur->Get(Form("purity_temp_pbpb_cent%d",j));
