...
{
  Float_t varLow = -50.0; 
  Float_t varHigh = 100.0; 
  Float_t purityBinVal = 0.99999; 
		       ...
		       TCut mcSignalCut, TCut dataWeightLabel, TString fname_SBcorr="", TTree *bkgmcTree=0)
{
  ...
  Float_t signalShift = 0.0; 
  Float_t backgroundShift = 0.0; 
  const Int_t nSIGMABINS = 100; 
  const Float_t minSIGMA = -20.0; 
  const Float_t maxSIGMA = 60.0; 
  ...
  TH1D* hCand = new TH1D("cand","",nSIGMABINS,minSIGMA,maxSIGMA);
  ...
  TString varHere="pho_sumIsoCorrected";
