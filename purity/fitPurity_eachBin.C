...
void fitPurity_eachBin(const TString coll="pp", const TString ver="190703_temp_v31_pur_SBcorr_centDep", const int function_number = 0, int Niter = 0, bool doSplitPD=true, bool doPreScale=false, bool drawGraph = true){
