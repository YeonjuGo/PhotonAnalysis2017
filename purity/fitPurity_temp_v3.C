...
void fitPurity_temp_v3(const TString coll="pbpb", const TString ver="190625_temp_v29_sys_purDown_test", bool doSplitPD=true, bool drawGraph = true, const int function_number = 0){
    ...
    TString outfName=Form("purity_withFunc_%s_%s_splitPD_noPreScale",coll.Data(),ver.Data());
    TString infName=Form("purity_%s_%s_splitPD_noPreScale",coll.Data(),ver.Data());
