...
int yj_quickPhotonPurity_v7_iteration_separateCent(const TString coll="pp", const TString ver="phoRaaCuts_purity_forPaper", bool doSplitPD=true, bool doPreScale=0, int centHere = 1, double sideband_i = 10, double sideband_f = 20, bool useSBcorr=0, bool centDepCorr=0, int ptDepCorrThr=0, int Nfunc=0, bool useMCSB=0, bool use30trig=0){
    cout << "Purity Calculation using yj_quickPhotonPurity_v7_iteration_separateCent.C" << endl;
...
int main(int argc, char* argv[]) {
    if (argc == 3)
        return yj_quickPhotonPurity_v7_iteration_separateCent(argv[1], argv[2]);
    if (argc == 4)
        return yj_quickPhotonPurity_v7_iteration_separateCent(argv[1], argv[2], atoi(argv[3]));
    if (argc == 5)
        return yj_quickPhotonPurity_v7_iteration_separateCent(argv[1], argv[2], atoi(argv[3]), atoi(argv[4]));
    if (argc == 6)
        return yj_quickPhotonPurity_v7_iteration_separateCent(argv[1], argv[2], atoi(argv[3]), atoi(argv[4]), atoi(argv[5]));
    return 1;
}
