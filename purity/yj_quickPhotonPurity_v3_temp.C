...
#include "../phoRaaCuts/phoRaaCuts_190703_temp_v31_sys_sig5GeV_bkg5to10.h"
...
int yj_quickPhotonPurity_v3_temp(const TString coll="pp", const TString ver="phoRaaCuts_purity_test", bool doSplitPD=true, bool doPreScale=0, bool useSBcorr=0, bool noCentDepCorr=0, bool useMCSB=0, bool use30trig=0){
...
int main(int argc, char* argv[]) {
    if (argc == 3)
        return yj_quickPhotonPurity_v3_temp(argv[1], argv[2]);
    if (argc == 4)
        return yj_quickPhotonPurity_v3_temp(argv[1], argv[2], atoi(argv[3]));
    if (argc == 5)
        return yj_quickPhotonPurity_v3_temp(argv[1], argv[2], atoi(argv[3]), atoi(argv[4]));
    if (argc == 6)
        return yj_quickPhotonPurity_v3_temp(argv[1], argv[2], atoi(argv[3]), atoi(argv[4]), atoi(argv[5]));
    return 1;
}
