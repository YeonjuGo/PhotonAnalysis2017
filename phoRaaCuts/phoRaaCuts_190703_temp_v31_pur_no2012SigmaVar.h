...
const int maxPurIter[] = {3,3,3,3,3};
...
//Noise Cuts
const TCut spikeRejection = "(phoSigmaIEtaIEta>=0.002) && (pho_swissCrx<=0.9) && (abs(pho_seedTime)<=3)";
...
const TCut sigmaCut = "phoSigmaIEtaIEta<0.010";
...
const TString purCap = "sigSumIso1_sidebandSumIso10to20";
...
/////////////// FOR PURITY ///////////////////
const TString purityVar= "phoSigmaIEtaIEta";
