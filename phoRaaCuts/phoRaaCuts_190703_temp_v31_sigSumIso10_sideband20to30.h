...
const TCut isoCut = "pho_sumIsoCorrected<10.0";
...
const TCut nonIsoSBCut = "pho_sumIsoCorrected > 20.0 && pho_sumIsoCorrected < 30.0";
...
const TString purCap = "sigSumIso10_sidebandSumIso20to30";
