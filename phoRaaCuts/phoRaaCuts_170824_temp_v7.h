#ifndef phoRaaCuts_170824_temp_v7_H
#define phoRaaCuts_170824_temp_v7_H
// 1. pp Iso(hoeCut_pp, sigmaCut_pp, isoCut_pp) is the one from Egamma POG;it's different with pbpb iso cuts 
// 2. pt and centrality binning is different from v6
// 3. Use 'phoSigmaIEtaIEta' for pp purity instead of 'phoSigmaIEtaIEta_2012' (same with v6)
#include <TCut.h>
