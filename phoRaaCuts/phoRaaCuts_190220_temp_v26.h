#ifndef phoRaaCuts_180822_temp_v24_H 
#define phoRaaCuts_180822_temp_v24_H 
...
//const double ptBins_unfolding[] = {15,20,30,40,50,60,80,100,130,200,270};
...
const TCut trigCut_mc = "(HLT_HISinglePhoton15_Eta1p5_v2==1 && phoEt>=15 && phoEt<20) || (HLT_HISinglePhoton20_Eta1p5_v2==1 && phoEt>=20 && phoEt<40) || (HLT_HISinglePhoton40_Eta1p5_v2==1 && phoEt>=40) ";
//const TCut trigCut_mc = "HLT_HISinglePhoton15_Eta1p5_v2";
//const TCut trigCut_mc_pp = "(1==1)";
const TCut trigCut_mc_pp = "(HLT_HISinglePhoton15_Eta1p5ForPPRef_v1==1 && phoEt>=15 && phoEt<20) || (HLT_HISinglePhoton20_Eta1p5ForPPRef_v1==1 && phoEt>=20 && phoEt<40) || (HLT_HISinglePhoton40_Eta1p5ForPPRef_v1==1 && phoEt>=40) ";
