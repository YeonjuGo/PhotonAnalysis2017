#ifndef phoRaaCuts_170711_temp_v6_H
#define phoRaaCuts_170711_temp_v6_H
// 1. Use SB correction method for purity calculation
// 2. pp Iso(hoeCut_pp, sigmaCut_pp, isoCut_pp) is the one from Egamma POG;it's different with pbpb iso cuts 
// 3. pt and centrality binning is the same with v5
// 4. Use 'phoSigmaIEtaIEta' for pp purity instead of 'phoSigmaIEtaIEta_2012'
#include <TCut.h>
...
/////////////// BINNING ///////////////////
const double ptBins[] = {40,45,50,60,80,100,999};
const double ptBins_draw[] = {40,45,50,60,80,100,120};
const int nPtBin = sizeof(ptBins)/sizeof(double) -1;
const double ptBins_i[] = {40,40,45,50,60,80,100};
const double ptBins_f[] = {999,45,50,60,80,100,999};
...
const TCut isoCut = "pho_sumIsoCorrected<5.0";
