#ifndef phoRaaCuts_170608_temp_v5_H
#define phoRaaCuts_170608_temp_v5_H
// 1. Use SB correction method for purity calculation
// 2. pp Iso(hoeCut_pp, sigmaCut_pp, isoCut_pp) is the same with pbpb other than that it's the same cuts with v1
// 3. exactly the same with v3 but pt and centrality binning is different
//
#include <TCut.h>
