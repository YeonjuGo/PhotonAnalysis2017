#ifndef phoRaaCuts_190222_temp_v27_H 
#define phoRaaCuts_190222_temp_v27_H 
...
const TCut trigCut_mc = "(HLT_HISinglePhoton15_Eta1p5_v2==1 && phoEtCorrected>=15 && phoEtCorrected<20) || (HLT_HISinglePhoton20_Eta1p5_v2==1 && phoEtCorrected>=20 && phoEtCorrected<30)  || (HLT_HISinglePhoton30_Eta1p5_v2==1 && phoEtCorrected>=30 && phoEtCorrected<40) || (HLT_HISinglePhoton40_Eta1p5_v2==1 && phoEtCorrected>=40) ";
