...
const double SB_pbpb_i[] = {5.0,7.0,6.0,4.0,1.0};
const double SB_pbpb_f[] = {15.0,17.0,16.0,14.0,11.0};
const double SB_interval_pp = 10.0;
...
const TString purCap = "sigSumIso1_sidebandSigEffat85_v2";
