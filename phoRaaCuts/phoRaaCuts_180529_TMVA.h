#ifndef phoRaaCuts_180529_TMVA_H 
#define phoRaaCuts_180529_TMVA_H 
// for photon PID study with TMVA 
...
const TCut mcBkgIsolation_forTMVA = "!((pho_genMatchedIndex!= -1) && abs(pho_genPID)==22 && pho_genCalIsoDR04<5 && (abs(pho_genMomPID)<=22 || pho_genMomPID==-999))";
