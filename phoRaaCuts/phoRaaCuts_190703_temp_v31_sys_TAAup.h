...
const double TA[nCentBinIF] = {5.762*1000,23.651*1000,11.814*1000,4.026*1000,0.4885*1000}; //TAAup
////const double TA[nCentBinIF] = {5.416*1000,22.531*1000,11.122*1000,3.611*1000,0.4075*1000}; //TAAdown
