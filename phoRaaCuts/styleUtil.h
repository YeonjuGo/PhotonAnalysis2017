...
#include "../ElectroWeak-Jet-Track-Analyses/Utilities/interface/ConfigurationParser.h"
...
void drawLatexCMS(TCanvas* c, bool drawLatexCMSExtra=1){
    c->cd();
    //TPad* pad = c->GetPad(1);
    //TPad* pad = new TPad("pad", "",0, windowHeightScale-1, 1/windowWidthScale, 1);
    ...
    latexCMS->SetTextSize(cmsTextSize*c->GetTopMargin());
