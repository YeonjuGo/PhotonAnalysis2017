...
const TCut isoCut = "pho_sumIsoCorrected<3.0";
...
const TCut nonIsoSBCut = "pho_sumIsoCorrected > 3.0 && pho_sumIsoCorrected < 13.0";
...
const TString purCap = "sigSumIso3_sidebandSumIso3to13";
