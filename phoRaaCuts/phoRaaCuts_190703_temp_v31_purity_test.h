...
const TCut mcBkgIsolation_onlyNM = "(pho_genMatchedIndex!= -1) && abs(pho_genPID)==22 && !(abs(pho_genMomPID)<=22 || pho_genMomPID==-999)";
const TCut mcBkgIsolation_PRpho_nonGenIso  = "(pho_genMatchedIndex!= -1) && abs(pho_genPID)==22 && !(pho_genCalIsoDR04<5) && (abs(pho_genMomPID)<=22 || pho_genMomPID==-999)";
