...
void compareThree(TTree* t1=0 ,TTree* t2=0,TString var="pt", int nBins=10, double xMin=0, double xMax=10, TCut cut1="",TCut cut2="", TCut cut3="", const char* cap="", const char* cap2="", bool isBkg=true);
void compare_sigmaIEtaIEta_iso_nonIso_3hist(TString coll="pp", TString ver="190703_temp_v31", bool isBkg=true){
...
void compareThree(TTree* t1, TTree* t2, TString var, int nBins, double xMin, double xMax, TCut cut1, TCut cut2, TCut cut3, const char* cap, const char* cap2, bool isBkg)  {
    SetHistTitleStyle();
    SetyjPadStyle();
    gStyle->SetOptStat(0);
    TH1::SetDefaultSumw2();
