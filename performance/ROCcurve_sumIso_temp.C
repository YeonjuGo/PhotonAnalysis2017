...
void ROCcurve_sumIso_temp(TString coll="pbpb", TString ver="190703_temp_v31"){
    ...
    const double ptBins_i_[] = {20,40,80};
    const double ptBins_f_[] = {40,80,200};
    //const double ptBins_i_[] = {20,25,30,40,50,60};
    //const double ptBins_f_[] = {25,30,40,50,60,80};
    ...
    const double sumIsoBins[] = {60,70,80,90,100};
    //const double sumIsoBins[] = {10,15,20,25,30,35,40,45,50,55};
    ...
    for(Int_t i = 0; i < nPtBinIF_; ++i) 
    {
        ...
        for(Int_t k = 0; k < nCENTBINS; ++k){ 
            ...
            cap+= "_sumIsoScan50to100";
            cout << cap << endl; 
                
            int Nden_sig = t1->GetEntries(Form("%s",sigMCCut.GetTitle()));
            int Nden_bkg = t2->GetEntries(Form("%s",bkgMCCut.GetTitle()));
