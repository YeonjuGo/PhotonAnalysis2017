...
void compareTwo(TTree* t1, TTree* t2, TString var, int nBins, double xMin, double xMax, TCut cut1, TCut cut2, const char* cap, const char* cap2)  {
    SetHistTitleStyle();
    SetyjPadStyle();
    gStyle->SetOptStat(0);
    TH1::SetDefaultSumw2();
    ...
    legStyle(l1);
    l1->AddEntry(h1,"EmEnrDijet Isolated","pl");
    l1->AddEntry(h1,"EmEnrDijet Non-isolated","l");
    l1->Draw();
