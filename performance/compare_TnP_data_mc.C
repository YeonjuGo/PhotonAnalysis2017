...
void compare_TnP_data_mc(TString coll="pp", TString cap="_Ze10e10", TString ver="v10", bool doWeight=true){
//void compare_TnP_data_mc(TString coll="pp", TString cap="_Ze10e10_Ze30eeJet", TString ver="v9"){
    TH1::SetDefaultSumw2();
    gStyle->SetOptStat(0);
    SetyjPadStyle();
    ...
    fname_data = Form("/home/goyeonju/CMS/2017/PhotonAnalysis2017/TnP/pho_TnP/fillTree/output_data_%s_%s.root",coll.Data(),ver.Data());
